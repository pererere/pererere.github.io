\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/tar/node\+\_\+modules/fs-\/minipass Directory Reference}
\hypertarget{dir_8e4088e712a9c471558fa4048714e24f}{}\label{dir_8e4088e712a9c471558fa4048714e24f}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/tar/node\_modules/fs-\/minipass Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/tar/node\_modules/fs-\/minipass Directory Reference}}
...
The async versions work much like their node builtin counterparts, with the exception of introducing significantly less Stream machinery overhead.\hypertarget{README.md_autotoc_md20238}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md20238}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20239}{}\doxysubsection{\texorpdfstring{Read\+Stream(path, options)}{Read\+Stream(path, options)}}\label{README.md_autotoc_md20239}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20240}{}\doxysubsection{\texorpdfstring{Write\+Stream(path, options)}{Write\+Stream(path, options)}}\label{README.md_autotoc_md20240}
Path string is required, but somewhat irrelevant if an open file descriptor is passed in as an option.
