\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/cross-\/spawn Directory Reference}
\hypertarget{dir_bf61b58516f66a161b509705b2385498}{}\label{dir_bf61b58516f66a161b509705b2385498}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/cross-\/spawn Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/cross-\/spawn Directory Reference}}
...
A cross platform solution to node\textquotesingle{}s spawn and spawn\+Sync.\hypertarget{README.md_autotoc_md5328}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md5328}
Node.\+js version 8 and up\+: {\ttfamily \$ npm install cross-\/spawn}

Node.\+js version 7 and under\+: {\ttfamily \$ npm install cross-\/spawn@6}\hypertarget{README.md_autotoc_md5329}{}\doxysubsection{\texorpdfstring{Why}{Why}}\label{README.md_autotoc_md5329}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md5331}{}\doxysubsection{\texorpdfstring{Caveats}{Caveats}}\label{README.md_autotoc_md5331}
\hypertarget{README.md_autotoc_md5332}{}\doxysubsubsection{\texorpdfstring{Using {\ttfamily options.\+shell} as an alternative to {\ttfamily cross-\/spawn}}{Using {\ttfamily options.\+shell} as an alternative to {\ttfamily cross-\/spawn}}}\label{README.md_autotoc_md5332}
...
If you are using the {\ttfamily shell} option to spawn a command in a cross platform way, consider using {\ttfamily cross-\/spawn} instead. You have been warned.\hypertarget{README.md_autotoc_md5333}{}\doxysubsubsection{\texorpdfstring{{\ttfamily options.\+shell} support}{{\ttfamily options.\+shell} support}}\label{README.md_autotoc_md5333}
...
This mimics the Node.\+js behavior. More specifically, the command and its arguments will not be automatically escaped nor shebang support will be offered. This is by design because if you are using {\ttfamily options.\+shell} you are probably targeting a specific platform anyway and you don\textquotesingle{}t want things to get into your way.\hypertarget{README.md_autotoc_md5334}{}\doxysubsubsection{\texorpdfstring{Shebangs support}{Shebangs support}}\label{README.md_autotoc_md5334}
...
Remember to always test your code on Windows!\hypertarget{README.md_autotoc_md5335}{}\doxysubsection{\texorpdfstring{Tests}{Tests}}\label{README.md_autotoc_md5335}
{\ttfamily \$ npm test} ~\newline
 {\ttfamily \$ npm test -\/-\/ -\/-\/watch} during development\hypertarget{README.md_autotoc_md5336}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md5336}
