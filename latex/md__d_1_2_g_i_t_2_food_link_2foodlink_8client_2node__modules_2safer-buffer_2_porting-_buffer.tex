...
\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer}{}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer}\index{Porting to the Buffer.from/Buffer.alloc API@{Porting to the Buffer.from/Buffer.alloc API}}
\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18362}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18362}%


\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_overview}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_overview}%
 \hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18363}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18363}

\begin{DoxyItemize}
\item \doxylink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}{Variant 1\+: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.} ({\itshape recommended})
\item \doxylink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}{Variant 2\+: Use a polyfill}
\item \doxylink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}{Variant 3\+: manual detection, with safeguards}
\end{DoxyItemize}\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18364}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using grep}{Finding problematic bits of code using grep}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18364}
...
It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18365}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using Node.\+js 8}{Finding problematic bits of code using Node.\+js 8}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18365}
...
\end{DoxyCode}
\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18366}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using linters}{Finding problematic bits of code using linters}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18366}
...
\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}%
 \hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18367}{}\doxysection{\texorpdfstring{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18367}
...
{\itshape If you currently support those older Node.\+js versions and dropping them would be a semver-\/major change for you, or if you support older branches of your packages, consider using \doxylink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}{Variant 2} or \doxylink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}{Variant 3} on older branches, so people using those older branches will also receive the fix. That way, you will eradicate potential issues caused by unguarded Buffer API usage and your users will not observe a runtime deprecation warning when running your code on Node.\+js 10.}

\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-2}%
 \hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18368}{}\doxysection{\texorpdfstring{Variant 2\+: Use a polyfill}{Variant 2\+: Use a polyfill}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18368}
Utilize \href{https://www.npmjs.com/package/safer-buffer}{\texttt{ safer-\/buffer}} as a polyfill to support older Node.\+js versions.

You would take exacly the same steps as in \doxylink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-1}{Variant 1}, but with a polyfill `const Buffer = require(\textquotesingle{}safer-\/buffer').Buffer{\ttfamily in all files where you use the new}Buffer\`{} api.
...
\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_variant-3}%
 \hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18369}{}\doxysection{\texorpdfstring{Variant 3 — manual detection, with safeguards}{Variant 3 — manual detection, with safeguards}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18369}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18370}{}\doxysubsection{\texorpdfstring{Buffer(0)}{Buffer(0)}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18370}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18371}{}\doxysubsection{\texorpdfstring{Buffer(not\+Number)}{Buffer(not\+Number)}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18371}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18372}{}\doxysubsection{\texorpdfstring{Buffer(number)}{Buffer(number)}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18372}
...
\end{DoxyCode}
\hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18373}{}\doxysection{\texorpdfstring{Regarding Buffer.\+alloc\+Unsafe}{Regarding Buffer.\+alloc\+Unsafe}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18373}
...
\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_faq}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_faq}%
 \hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18374}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18374}
\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_design-flaws}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_design-flaws}%
 \hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18375}{}\doxysubsection{\texorpdfstring{What is wrong with the {\ttfamily Buffer} constructor?}{What is wrong with the {\ttfamily Buffer} constructor?}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18375}
...
\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_ecosystem-usage}%
\Hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_ecosystem-usage}%
 \hypertarget{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18376}{}\doxysubsection{\texorpdfstring{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}}\label{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2safer-buffer_2_porting-_buffer_autotoc_md18376}
