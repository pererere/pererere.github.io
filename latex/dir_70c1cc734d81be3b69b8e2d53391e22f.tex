\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/get-\/stream Directory Reference}
\hypertarget{dir_70c1cc734d81be3b69b8e2d53391e22f}{}\label{dir_70c1cc734d81be3b69b8e2d53391e22f}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/get-\/stream Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/get-\/stream Directory Reference}}


\doxysubsection{Detailed Description}
\begin{quote}
Get a stream as a string, buffer, or array \end{quote}
\hypertarget{readme.md_autotoc_md8416}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{readme.md_autotoc_md8416}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ get-\/stream}

\end{DoxyCode}
\hypertarget{readme.md_autotoc_md8417}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{readme.md_autotoc_md8417}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md8418}{}\doxysubsection{\texorpdfstring{API}{API}}\label{readme.md_autotoc_md8418}
The methods returns a promise that resolves when the {\ttfamily end} event fires on the stream, indicating that there is no more data to be read. The stream is switched to flowing mode.\hypertarget{readme.md_autotoc_md8419}{}\doxysubsubsection{\texorpdfstring{get\+Stream(stream, options?)}{get\+Stream(stream, options?)}}\label{readme.md_autotoc_md8419}
Get the {\ttfamily stream} as a string.\hypertarget{readme.md_autotoc_md8420}{}\doxysubsubsubsection{\texorpdfstring{options}{options}}\label{readme.md_autotoc_md8420}
Type\+: {\ttfamily object}\hypertarget{readme.md_autotoc_md8421}{}\doxysubsubsubsubsection{\texorpdfstring{encoding}{encoding}}\label{readme.md_autotoc_md8421}
Type\+: {\ttfamily string}\textbackslash{} Default\+: `\textquotesingle{}utf8'\`{}

\href{https://nodejs.org/api/buffer.html\#buffer_buffer}{\texttt{ Encoding}} of the incoming stream.\hypertarget{readme.md_autotoc_md8422}{}\doxysubsubsubsubsection{\texorpdfstring{max\+Buffer}{max\+Buffer}}\label{readme.md_autotoc_md8422}
Type\+: {\ttfamily number}\textbackslash{} Default\+: {\ttfamily Infinity}

Maximum length of the returned string. If it exceeds this value before the stream ends, the promise will be rejected with a {\ttfamily get\+Stream.\+Max\+Buffer\+Error} error.\hypertarget{readme.md_autotoc_md8423}{}\doxysubsubsection{\texorpdfstring{get\+Stream.\+buffer(stream, options?)}{get\+Stream.\+buffer(stream, options?)}}\label{readme.md_autotoc_md8423}
Get the {\ttfamily stream} as a buffer.

It honors the {\ttfamily max\+Buffer} option as above, but it refers to byte length rather than string length.\hypertarget{readme.md_autotoc_md8424}{}\doxysubsubsection{\texorpdfstring{get\+Stream.\+array(stream, options?)}{get\+Stream.\+array(stream, options?)}}\label{readme.md_autotoc_md8424}
...
\end{DoxyItemize}\hypertarget{readme.md_autotoc_md8425}{}\doxysubsection{\texorpdfstring{Errors}{Errors}}\label{readme.md_autotoc_md8425}
...
\end{DoxyCode}
\hypertarget{readme.md_autotoc_md8426}{}\doxysubsection{\texorpdfstring{FAQ}{FAQ}}\label{readme.md_autotoc_md8426}
\hypertarget{readme.md_autotoc_md8427}{}\doxysubsubsection{\texorpdfstring{How is this different from \href{https://github.com/maxogden/concat-stream}{\texttt{ {\ttfamily concat-\/stream}}}?}{How is this different from \href{https://github.com/maxogden/concat-stream}{\texttt{ {\ttfamily concat-\/stream}}}?}}\label{readme.md_autotoc_md8427}
This module accepts a stream instead of being one and returns a promise instead of using a callback. The API is simpler and it only supports returning a string, buffer, or array. It doesn\textquotesingle{}t have a fragile type inference. You explicitly choose what you want. And it doesn\textquotesingle{}t depend on the huge {\ttfamily readable-\/stream} package.\hypertarget{readme.md_autotoc_md8428}{}\doxysubsection{\texorpdfstring{Related}{Related}}\label{readme.md_autotoc_md8428}
