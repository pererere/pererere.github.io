\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/source-\/map-\/support Directory Reference}
\hypertarget{dir_e1fbb7c1c3afbe705ea0f83080ddb736}{}\label{dir_e1fbb7c1c3afbe705ea0f83080ddb736}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/source-\/map-\/support Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/source-\/map-\/support Directory Reference}}


\doxysubsection{Detailed Description}
\href{https://travis-ci.org/evanw/node-source-map-support}{\texttt{ }}

This module provides source map support for stack traces in node via the \href{https://github.com/v8/v8/wiki/Stack-Trace-API}{\texttt{ V8 stack trace API}}. It uses the \href{https://github.com/mozilla/source-map}{\texttt{ source-\/map}} module to replace the paths and line numbers of source-\/mapped files with their original paths and line numbers. The output mimics node\textquotesingle{}s stack trace format with the goal of making every compile-\/to-\/\+JS language more of a first-\/class citizen. Source maps are completely general (not specific to any one language) so you can use source maps with multiple compile-\/to-\/\+JS languages in the same node process.\hypertarget{README.md_autotoc_md19748}{}\doxysubsection{\texorpdfstring{Installation and Usage}{Installation and Usage}}\label{README.md_autotoc_md19748}
\hypertarget{README.md_autotoc_md19749}{}\doxysubsubsubsection{\texorpdfstring{Node support}{Node support}}\label{README.md_autotoc_md19749}
...
From here you have two options.\hypertarget{README.md_autotoc_md19750}{}\doxysubsubsubsubsection{\texorpdfstring{CLI Usage}{CLI Usage}}\label{README.md_autotoc_md19750}

\begin{DoxyCode}{0}
\DoxyCodeLine{node\ -\/r\ source-\/map-\/support/register\ compiled.js}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md19751}{}\doxysubsubsubsubsection{\texorpdfstring{Programmatic Usage}{Programmatic Usage}}\label{README.md_autotoc_md19751}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19752}{}\doxysubsubsubsection{\texorpdfstring{Browser support}{Browser support}}\label{README.md_autotoc_md19752}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19753}{}\doxysubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md19753}
...
This monkey patches the {\ttfamily require} module loading chain, so is not enabled by default and is not recommended for any sort of production usage.\hypertarget{README.md_autotoc_md19754}{}\doxysubsection{\texorpdfstring{Demos}{Demos}}\label{README.md_autotoc_md19754}
\hypertarget{README.md_autotoc_md19755}{}\doxysubsubsubsection{\texorpdfstring{Basic Demo}{Basic Demo}}\label{README.md_autotoc_md19755}
original.\+js\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19756}{}\doxysubsubsubsection{\texorpdfstring{Type\+Script Demo}{Type\+Script Demo}}\label{README.md_autotoc_md19756}
demo.\+ts\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19757}{}\doxysubsubsubsection{\texorpdfstring{Coffee\+Script Demo}{Coffee\+Script Demo}}\label{README.md_autotoc_md19757}
demo.\+coffee\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19758}{}\doxysubsection{\texorpdfstring{Tests}{Tests}}\label{README.md_autotoc_md19758}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md19759}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md19759}
