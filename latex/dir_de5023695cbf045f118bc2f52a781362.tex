\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/http-\/errors Directory Reference}
\hypertarget{dir_de5023695cbf045f118bc2f52a781362}{}\label{dir_de5023695cbf045f118bc2f52a781362}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/http-\/errors Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/http-\/errors Directory Reference}}
...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{README.md_autotoc_md8847}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md8847}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8848}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{README.md_autotoc_md8848}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8849}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md8849}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{README.md_autotoc_md8850}{}\doxysubsubsection{\texorpdfstring{Error Properties}{Error Properties}}\label{README.md_autotoc_md8850}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md8851}{}\doxysubsubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}}\label{README.md_autotoc_md8851}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md8852}{}\doxysubsubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}}\label{README.md_autotoc_md8852}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{README.md_autotoc_md8853}{}\doxysubsubsection{\texorpdfstring{create\+Error.\+is\+Http\+Error(val)}{create\+Error.\+is\+Http\+Error(val)}}\label{README.md_autotoc_md8853}
Determine if the provided {\ttfamily val} is an {\ttfamily Http\+Error}. This will return {\ttfamily true} if the error inherits from the {\ttfamily Http\+Error} constructor of this module or matches the "{}duck type"{} for an error this module creates. All outputs from the {\ttfamily create\+Error} factory will return {\ttfamily true} for this function, including if an non-\/{\ttfamily Http\+Error} was passed into the factory.\hypertarget{README.md_autotoc_md8854}{}\doxysubsubsection{\texorpdfstring{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}}\label{README.md_autotoc_md8854}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md8855}{}\doxysubsubsubsection{\texorpdfstring{List of all constructors}{List of all constructors}}\label{README.md_autotoc_md8855}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{README.md_autotoc_md8856}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md8856}
