\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/node-\/gyp Directory Reference}
\hypertarget{dir_6c1cefc59853334c7c5cba2fca53e5e5}{}\label{dir_6c1cefc59853334c7c5cba2fca53e5e5}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/node-\/gyp Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/node-\/gyp Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \mbox{\hyperlink{dir_b5ffe7db481af69c6dc3a04fc948ae99}{gyp}}
\item 
directory \mbox{\hyperlink{dir_815f1856639d122654d7004f3f19887d}{lib}}
\item 
directory \mbox{\hyperlink{dir_9ee07e2e2aa7df6f7add789224a7764c}{src}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\href{https://github.com/nodejs/node-gyp/actions?query=workflow\%3ATests+branch\%3Amain}{\texttt{ }} 
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md15096}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md15096}
...
Depending on your operating system, you will need to install\+:\hypertarget{README.md_autotoc_md15097}{}\doxysubsubsection{\texorpdfstring{On Unix}{On Unix}}\label{README.md_autotoc_md15097}

\begin{DoxyItemize}
\item \href{https://devguide.python.org/versions/}{\texttt{ A supported version of Python}}
\item {\ttfamily make}
\item A proper C/\+C++ compiler toolchain, like \href{https://gcc.gnu.org}{\texttt{ GCC}}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md15098}{}\doxysubsubsection{\texorpdfstring{On mac\+OS}{On mac\+OS}}\label{README.md_autotoc_md15098}

\begin{DoxyItemize}
\item \href{https://devguide.python.org/versions/}{\texttt{ A supported version of Python}}
\item {\ttfamily Xcode Command Line Tools} which will install {\ttfamily clang}, {\ttfamily clang++}, and {\ttfamily make}.
\begin{DoxyItemize}
\item Install the {\ttfamily Xcode Command Line Tools} standalone by running {\ttfamily xcode-\/select -\/-\/install}. -- OR --
\item Alternatively, if you already have the \href{https://developer.apple.com/xcode/download/}{\texttt{ full Xcode installed}}, you can install the Command Line Tools under the menu {\ttfamily Xcode -\/\texorpdfstring{$>$}{>} Open Developer Tool -\/\texorpdfstring{$>$}{>} More Developer Tools...}.
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md15099}{}\doxysubsubsection{\texorpdfstring{On Windows}{On Windows}}\label{README.md_autotoc_md15099}
Install the current \href{https://devguide.python.org/versions/}{\texttt{ version of Python}} from the \href{https://apps.microsoft.com/store/search?publisher=Python+Software+Foundation}{\texttt{ Microsoft Store}}.

Install tools and configuration manually\+:
\begin{DoxyItemize}
\item Install Visual C++ Build Environment\+: \href{https://visualstudio.microsoft.com/thank-you-downloading-visual-studio/?sku=BuildTools}{\texttt{ Visual Studio Build Tools}} (using "{}\+Visual C++ build tools"{} if using a version older than VS2019, otherwise use "{}\+Desktop development with C++"{} workload) or \href{https://visualstudio.microsoft.com/thank-you-downloading-visual-studio/?sku=Community}{\texttt{ Visual Studio Community}} (using the "{}\+Desktop development with C++"{} workload)
\end{DoxyItemize}
...
To use the native ARM64 C++ compiler on Windows on ARM, ensure that you have Visual Studio 2022 \href{https://devblogs.microsoft.com/visualstudio/arm64-visual-studio-is-officially-here/}{\texttt{ 17.\+4 or later}} installed.\hypertarget{README.md_autotoc_md15100}{}\doxysubsubsection{\texorpdfstring{Configuring Python Dependency}{Configuring Python Dependency}}\label{README.md_autotoc_md15100}
{\ttfamily node-\/gyp} requires that you have installed a \href{https://devguide.python.org/versions/}{\texttt{ supported version of Python}}. If you have multiple versions of Python installed, you can identify which version {\ttfamily node-\/gyp} should use in one of the following ways\+:
...
\begin{DoxyEnumerate}
\item If {\ttfamily node-\/gyp} is called by way of {\ttfamily npm}, {\itshape and} you have multiple versions of Python installed, then you can set the {\ttfamily npm\+\_\+config\+\_\+python} environment variable to the appropriate path\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\ bash}
\DoxyCodeLine{export\ npm\_config\_python=/path/to/executable/python}

\end{DoxyCode}
 ~~~~Or on Windows\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{py\ -\/-\/list-\/paths\ \ \#\ To\ see\ the\ installed\ Python\ versions}
\DoxyCodeLine{set\ npm\_config\_python=C:\(\backslash\)path\(\backslash\)to\(\backslash\)python.exe}

\end{DoxyCode}

\item If the {\ttfamily PYTHON} environment variable is set to the path of a Python executable, then that version will be used if it is a supported version.
\item If the {\ttfamily NODE\+\_\+\+GYP\+\_\+\+FORCE\+\_\+\+PYTHON} environment variable is set to the path of a Python executable, it will be used instead of any of the other configured or built-\/in Python search paths. If it\textquotesingle{}s not a compatible version, no further searching will be done.
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md15101}{}\doxysubsubsection{\texorpdfstring{Build for Third Party Node.\+js Runtimes}{Build for Third Party Node.\+js Runtimes}}\label{README.md_autotoc_md15101}
When building modules for third-\/party Node.\+js runtimes like Electron, which have different build configurations from the official Node.\+js distribution, you should use {\ttfamily -\/-\/dist-\/url} or {\ttfamily -\/-\/nodedir} flags to specify the headers of the runtime to build for.
...
{\bfseries{Note\+:}} To create a {\itshape Debug} build of the bindings file, pass the {\ttfamily -\/-\/debug} (or {\ttfamily -\/d}) switch when running either the {\ttfamily configure}, {\ttfamily build} or {\ttfamily rebuild} commands.\hypertarget{README.md_autotoc_md15103}{}\doxysubsection{\texorpdfstring{The {\ttfamily binding.\+gyp} file}{The {\ttfamily binding.\+gyp} file}}\label{README.md_autotoc_md15103}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md15104}{}\doxysubsection{\texorpdfstring{Further reading}{Further reading}}\label{README.md_autotoc_md15104}
...
\item \href{https://github.com/nodejs/node/tree/main/test/addons/hello-world}{\texttt{ "{}\+Hello World"{} node addon example}}
...
\item {\itshape "{}binding.gyp"{} files out in the wild} wiki page
\end{DoxyItemize}\hypertarget{README.md_autotoc_md15105}{}\doxysubsection{\texorpdfstring{Commands}{Commands}}\label{README.md_autotoc_md15105}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md15106}{}\doxysubsection{\texorpdfstring{Command Options}{Command Options}}\label{README.md_autotoc_md15106}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md15107}{}\doxysubsection{\texorpdfstring{Configuration}{Configuration}}\label{README.md_autotoc_md15107}
\hypertarget{README.md_autotoc_md15108}{}\doxysubsubsection{\texorpdfstring{Environment variables}{Environment variables}}\label{README.md_autotoc_md15108}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md15109}{}\doxysubsubsection{\texorpdfstring{{\ttfamily npm} configuration for npm versions before v9}{{\ttfamily npm} configuration for npm versions before v9}}\label{README.md_autotoc_md15109}
...
{\bfseries{Note\+:}} Configuration set via {\ttfamily npm} will only be used when {\ttfamily node-\/gyp} is run via {\ttfamily npm}, not when {\ttfamily node-\/gyp} is run directly.\hypertarget{README.md_autotoc_md15110}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md15110}
