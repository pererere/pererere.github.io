\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/express/node\+\_\+modules/send/node\+\_\+modules/encodeurl Directory Reference}
\hypertarget{dir_9d3e45a69c59831b06b6cd8906eed016}{}\label{dir_9d3e45a69c59831b06b6cd8906eed016}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/express/node\_modules/send/node\_modules/encodeurl Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/express/node\_modules/send/node\_modules/encodeurl Directory Reference}}
...
Encode a URL to a percent-\/encoded form, excluding already-\/encoded sequences\hypertarget{README.md_autotoc_md7436}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md7436}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md7437}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md7437}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ encodeUrl\ =\ require('encodeurl')}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md7438}{}\doxysubsubsection{\texorpdfstring{encode\+Url(url)}{encode\+Url(url)}}\label{README.md_autotoc_md7438}
...
This function is {\itshape similar} to the intrinsic function {\ttfamily encode\+URI}, except it will not encode the {\ttfamily \%} character if that is part of a valid sequence, will not encode {\ttfamily \mbox{[}} and {\ttfamily \mbox{]}} (for IPv6 hostnames) and will replace raw, unpaired surrogate pairs with the Unicode replacement character (instead of throwing).\hypertarget{README.md_autotoc_md7439}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{README.md_autotoc_md7439}
\hypertarget{README.md_autotoc_md7440}{}\doxysubsubsection{\texorpdfstring{Encode a URL containing user-\/controled data}{Encode a URL containing user-\/controled data}}\label{README.md_autotoc_md7440}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md7441}{}\doxysubsubsection{\texorpdfstring{Encode a URL for use in a header field}{Encode a URL for use in a header field}}\label{README.md_autotoc_md7441}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md7442}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md7442}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md7443}{}\doxysubsection{\texorpdfstring{References}{References}}\label{README.md_autotoc_md7443}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md7444}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md7444}
