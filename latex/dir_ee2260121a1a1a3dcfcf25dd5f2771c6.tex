\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/path-\/scurry Directory Reference}
\hypertarget{dir_ee2260121a1a1a3dcfcf25dd5f2771c6}{}\label{dir_ee2260121a1a1a3dcfcf25dd5f2771c6}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/path-\/scurry Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/path-\/scurry Directory Reference}}


\doxysubsection{Detailed Description}
Extremely high performant utility for building tools that read the file system, minimizing filesystem and path string munging operations to the greatest degree possible.\hypertarget{README.md_autotoc_md16089}{}\doxysubsection{\texorpdfstring{Ugh, yet another file traversal thing on npm?}{Ugh, yet another file traversal thing on npm?}}\label{README.md_autotoc_md16089}
Yes. None of the existing ones gave me exactly what I wanted.\hypertarget{README.md_autotoc_md16090}{}\doxysubsection{\texorpdfstring{Well what is it you wanted?}{Well what is it you wanted?}}\label{README.md_autotoc_md16090}
...
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md16091}{}\doxysubsection{\texorpdfstring{PERFORMANCE}{PERFORMANCE}}\label{README.md_autotoc_md16091}
...
If you can think of a case that is not covered in these benchmarks, or an implementation that performs significantly better than Path\+Scurry, please \href{https://github.com/isaacs/path-scurry/issues}{\texttt{ let me know}}.\hypertarget{README.md_autotoc_md16092}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md16092}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md16093}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md16093}
...
Intended public API is documented here, but the full documentation does include internal types, which should not be accessed directly.\hypertarget{README.md_autotoc_md16094}{}\doxysubsubsection{\texorpdfstring{Interface {\ttfamily Path\+Scurry\+Opts}}{Interface {\ttfamily Path\+Scurry\+Opts}}}\label{README.md_autotoc_md16094}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md16095}{}\doxysubsubsection{\texorpdfstring{Interface {\ttfamily Walk\+Options}}{Interface {\ttfamily Walk\+Options}}}\label{README.md_autotoc_md16095}
...
Note that Type\+Script return types will only be inferred properly from static analysis if the {\ttfamily with\+File\+Types} option is omitted, or a constant {\ttfamily true} or {\ttfamily false} value.\hypertarget{README.md_autotoc_md16096}{}\doxysubsubsection{\texorpdfstring{Class {\ttfamily Path\+Scurry}}{Class {\ttfamily Path\+Scurry}}}\label{README.md_autotoc_md16096}
...
All walk methods may be called with a {\ttfamily Walk\+Options} argument to walk over the object\textquotesingle{}s current working directory with the supplied options.\hypertarget{README.md_autotoc_md16097}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async pw.\+walk(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}{{\ttfamily async pw.\+walk(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}}\label{README.md_autotoc_md16097}
Walk the directory tree according to the options provided, resolving to an array of all entries found.\hypertarget{README.md_autotoc_md16098}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+walk\+Sync(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}{{\ttfamily pw.\+walk\+Sync(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}}\label{README.md_autotoc_md16098}
Walk the directory tree according to the options provided, returning an array of all entries found.\hypertarget{README.md_autotoc_md16099}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+iterate(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}{{\ttfamily pw.\+iterate(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}}\label{README.md_autotoc_md16099}
Iterate over the directory asynchronously, for use with {\ttfamily for await of}. This is also the default async iterator method.\hypertarget{README.md_autotoc_md16100}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+iterate\+Sync(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}{{\ttfamily pw.\+iterate\+Sync(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}}\label{README.md_autotoc_md16100}
Iterate over the directory synchronously, for use with {\ttfamily for of}. This is also the default sync iterator method.\hypertarget{README.md_autotoc_md16101}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+stream(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}{{\ttfamily pw.\+stream(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}}\label{README.md_autotoc_md16101}
Return a \href{http://npm.im/minipass}{\texttt{ Minipass}} stream that emits each entry or path string in the walk. Results are made available asynchronously.\hypertarget{README.md_autotoc_md16102}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+stream\+Sync(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}{{\ttfamily pw.\+stream\+Sync(entry?\+: string \texorpdfstring{$\vert$}{|} Path \texorpdfstring{$\vert$}{|} Walk\+Options, opts?\+: Walk\+Options)}}}\label{README.md_autotoc_md16102}
Return a \href{http://npm.im/minipass}{\texttt{ Minipass}} stream that emits each entry or path string in the walk. Results are made available synchronously, meaning that the walk will complete in a single tick if the stream is fully consumed.\hypertarget{README.md_autotoc_md16103}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+cwd}}{{\ttfamily pw.\+cwd}}}\label{README.md_autotoc_md16103}
Path object representing the current working directory for the Path\+Scurry.\hypertarget{README.md_autotoc_md16104}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+chdir(path\+: string)}}{{\ttfamily pw.\+chdir(path\+: string)}}}\label{README.md_autotoc_md16104}
Set the new effective current working directory for the scurry object, so that {\ttfamily path.\+relative()} and {\ttfamily path.\+relative\+Posix()} return values relative to the new cwd path.\hypertarget{README.md_autotoc_md16105}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+depth(path?\+: Path \texorpdfstring{$\vert$}{|} string)\+: number}}{{\ttfamily pw.\+depth(path?\+: Path \texorpdfstring{$\vert$}{|} string)\+: number}}}\label{README.md_autotoc_md16105}
Return the depth of the specified path (or the Path\+Scurry cwd) within the directory tree.

Root entries have a depth of {\ttfamily 0}.\hypertarget{README.md_autotoc_md16106}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+resolve(...\+paths\+: string\mbox{[}$\,$\mbox{]})}}{{\ttfamily pw.\+resolve(...\+paths\+: string\mbox{[}$\,$\mbox{]})}}}\label{README.md_autotoc_md16106}
...
To get a {\ttfamily Path} object resolved from the {\ttfamily Path\+Scurry}, use {\ttfamily pw.\+cwd.\+resolve(path)}. Note that {\ttfamily Path.\+resolve} only takes a single string argument, not multiple.\hypertarget{README.md_autotoc_md16107}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+resolve\+Posix(...\+paths\+: string\mbox{[}$\,$\mbox{]})}}{{\ttfamily pw.\+resolve\+Posix(...\+paths\+: string\mbox{[}$\,$\mbox{]})}}}\label{README.md_autotoc_md16107}
...
On Windows, it returns the full absolute UNC path using {\ttfamily /} separators. Ie, instead of {\ttfamily \textquotesingle{}C\+:\textbackslash{}\textbackslash{}foo\textbackslash{}\textbackslash{}bar}, it would return {\ttfamily //?/C\+:/foo/bar}.\hypertarget{README.md_autotoc_md16108}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+relative(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}{{\ttfamily pw.\+relative(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}}\label{README.md_autotoc_md16108}
Return the relative path from the Path\+Walker cwd to the supplied path string or entry.

If the nearest common ancestor is the root, then an absolute path is returned.\hypertarget{README.md_autotoc_md16109}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+relative\+Posix(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}{{\ttfamily pw.\+relative\+Posix(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}}\label{README.md_autotoc_md16109}
...
On Windows systems, it returns the resulting string as a {\ttfamily /}-\/delimited path. If an absolute path is returned (because the target does not share a common ancestor with {\ttfamily pw.\+cwd}), then a full absolute UNC path will be returned. Ie, instead of {\ttfamily \textquotesingle{}C\+:\textbackslash{}\textbackslash{}foo\textbackslash{}\textbackslash{}bar}, it would return {\ttfamily //?/C\+:/foo/bar}.\hypertarget{README.md_autotoc_md16110}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+basename(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}{{\ttfamily pw.\+basename(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}}\label{README.md_autotoc_md16110}
Return the basename of the provided string or Path.\hypertarget{README.md_autotoc_md16111}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+dirname(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}{{\ttfamily pw.\+dirname(path\+: string \texorpdfstring{$\vert$}{|} Path)\+: string}}}\label{README.md_autotoc_md16111}
Return the parent directory of the supplied string or Path.\hypertarget{README.md_autotoc_md16112}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async pw.\+readdir(dir = pw.\+cwd, opts = \{ with\+File\+Types\+: true \})}}{{\ttfamily async pw.\+readdir(dir = pw.\+cwd, opts = \{ with\+File\+Types\+: true \})}}}\label{README.md_autotoc_md16112}
...
Note that Type\+Script return types will only be inferred properly from static analysis if the {\ttfamily with\+File\+Types} option is omitted, or a constant {\ttfamily true} or {\ttfamily false} value.\hypertarget{README.md_autotoc_md16113}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+readdir\+Sync(dir = pw.\+cwd, opts = \{ with\+File\+Types\+: true \})}}{{\ttfamily pw.\+readdir\+Sync(dir = pw.\+cwd, opts = \{ with\+File\+Types\+: true \})}}}\label{README.md_autotoc_md16113}
Synchronous {\ttfamily pw.\+readdir()}\hypertarget{README.md_autotoc_md16114}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async pw.\+readlink(link = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}{{\ttfamily async pw.\+readlink(link = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}}\label{README.md_autotoc_md16114}
...
Note that Type\+Script return types will only be inferred properly from static analysis if the {\ttfamily with\+File\+Types} option is omitted, or a constant {\ttfamily true} or {\ttfamily false} value.\hypertarget{README.md_autotoc_md16115}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+readlink\+Sync(link = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}{{\ttfamily pw.\+readlink\+Sync(link = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}}\label{README.md_autotoc_md16115}
Synchronous {\ttfamily pw.\+readlink()}\hypertarget{README.md_autotoc_md16116}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async pw.\+lstat(entry = pw.\+cwd)}}{{\ttfamily async pw.\+lstat(entry = pw.\+cwd)}}}\label{README.md_autotoc_md16116}
...
Note that some {\ttfamily Stats} data (such as {\ttfamily ino}, {\ttfamily dev}, and {\ttfamily mode}) will not be supplied. For those things, you\textquotesingle{}ll need to call {\ttfamily fs.\+lstat} yourself.\hypertarget{README.md_autotoc_md16117}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+lstat\+Sync(entry = pw.\+cwd)}}{{\ttfamily pw.\+lstat\+Sync(entry = pw.\+cwd)}}}\label{README.md_autotoc_md16117}
Synchronous {\ttfamily pw.\+lstat()}\hypertarget{README.md_autotoc_md16118}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+realpath(entry = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}{{\ttfamily pw.\+realpath(entry = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}}\label{README.md_autotoc_md16118}
...
May be called as {\ttfamily pw.\+realpath(\{ with\+File\+Types\+: boolean \})} to run on {\ttfamily pw.\+cwd}.\hypertarget{README.md_autotoc_md16119}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily pw.\+realpath\+Sync(entry = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}{{\ttfamily pw.\+realpath\+Sync(entry = pw.\+cwd, opts = \{ with\+File\+Types\+: false \})}}}\label{README.md_autotoc_md16119}
Synchronous {\ttfamily pw.\+realpath()}\hypertarget{README.md_autotoc_md16120}{}\doxysubsubsection{\texorpdfstring{Class {\ttfamily Path} implements \href{https://nodejs.org/docs/latest/api/fs.html\#class-fsdirent}{\texttt{ fs.\+Dirent}}}{Class {\ttfamily Path} implements \href{https://nodejs.org/docs/latest/api/fs.html\#class-fsdirent}{\texttt{ fs.\+Dirent}}}}\label{README.md_autotoc_md16120}
...
In {\ttfamily Path\+Win32} implementations, paths are split using either `'/\textquotesingle{}{\ttfamily or}\textquotesingle{}\textbackslash{}\textquotesingle{}{\ttfamily and joined using}\textquotesingle{}\textbackslash{}\textquotesingle{}{\ttfamily , and multiple roots may be in use based on the drives and UNC paths encountered. UNC paths such as}//?/C\+:/{\ttfamily that identify a drive letter, will be treated as an alias for the same root entry as their associated drive letter (in this case}\textquotesingle{}C\+:\textbackslash{}\textquotesingle{}\`{}).\hypertarget{README.md_autotoc_md16121}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+name}}{{\ttfamily path.\+name}}}\label{README.md_autotoc_md16121}
Name of this file system entry.

{\bfseries{Important}}\+: {\itshape always} test the path name against any test string using the {\ttfamily is\+Named} method, and not by directly comparing this string. Otherwise, unicode path strings that the system sees as identical will not be properly treated as the same path, leading to incorrect behavior and possible security issues.\hypertarget{README.md_autotoc_md16122}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+is\+Named(name\+: string)\+: boolean}}{{\ttfamily path.\+is\+Named(name\+: string)\+: boolean}}}\label{README.md_autotoc_md16122}
...
Always use this method instead of testing the {\ttfamily path.\+name} property directly.\hypertarget{README.md_autotoc_md16123}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+get\+Type()}}{{\ttfamily path.\+get\+Type()}}}\label{README.md_autotoc_md16123}
Returns the type of the Path object, `\textquotesingle{}File'{\ttfamily ,}\textquotesingle{}Directory\textquotesingle{}\`{}, etc.\hypertarget{README.md_autotoc_md16124}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+is\+Type(t\+: type)}}{{\ttfamily path.\+is\+Type(t\+: type)}}}\label{README.md_autotoc_md16124}
Returns true if {\ttfamily is\{t\}()} returns true.

For example, `path.\+is\+Type(\textquotesingle{}Directory'){\ttfamily is equivalent to }path.\+is\+Directory()\`{}.\hypertarget{README.md_autotoc_md16125}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+depth()}}{{\ttfamily path.\+depth()}}}\label{README.md_autotoc_md16125}
Return the depth of the Path entry within the directory tree. Root paths have a depth of {\ttfamily 0}.\hypertarget{README.md_autotoc_md16126}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+fullpath()}}{{\ttfamily path.\+fullpath()}}}\label{README.md_autotoc_md16126}
The fully resolved path to the entry.\hypertarget{README.md_autotoc_md16127}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+fullpath\+Posix()}}{{\ttfamily path.\+fullpath\+Posix()}}}\label{README.md_autotoc_md16127}
The fully resolved path to the entry, using {\ttfamily /} separators.

On posix systems, this is identical to {\ttfamily path.\+fullpath()}. On windows, this will return a fully resolved absolute UNC path using {\ttfamily /} separators. Eg, instead of `\textquotesingle{}C\+:\textbackslash{}foo\textbackslash{}bar'{\ttfamily , it will return}\textquotesingle{}//?/C\+:/foo/bar\textquotesingle{}\`{}.\hypertarget{README.md_autotoc_md16128}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+is\+File()}, {\ttfamily path.\+is\+Directory()}, etc.}{{\ttfamily path.\+is\+File()}, {\ttfamily path.\+is\+Directory()}, etc.}}\label{README.md_autotoc_md16128}
Same as the identical {\ttfamily fs.\+Dirent.\+is\+X()} methods.\hypertarget{README.md_autotoc_md16129}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+is\+Unknown()}}{{\ttfamily path.\+is\+Unknown()}}}\label{README.md_autotoc_md16129}
Returns true if the path\textquotesingle{}s type is unknown. Always returns true when the path is known to not exist.\hypertarget{README.md_autotoc_md16130}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+resolve(p\+: string)}}{{\ttfamily path.\+resolve(p\+: string)}}}\label{README.md_autotoc_md16130}
Return a {\ttfamily Path} object associated with the provided path string as resolved from the current Path object.\hypertarget{README.md_autotoc_md16131}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+relative()\+: string}}{{\ttfamily path.\+relative()\+: string}}}\label{README.md_autotoc_md16131}
Return the relative path from the Path\+Walker cwd to the supplied path string or entry.

If the nearest common ancestor is the root, then an absolute path is returned.\hypertarget{README.md_autotoc_md16132}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+relative\+Posix()\+: string}}{{\ttfamily path.\+relative\+Posix()\+: string}}}\label{README.md_autotoc_md16132}
Return the relative path from the Path\+Walker cwd to the supplied path string or entry, using {\ttfamily /} path separators.
...
On Windows systems, it returns the resulting string as a {\ttfamily /}-\/delimited path. If an absolute path is returned (because the target does not share a common ancestor with {\ttfamily pw.\+cwd}), then a full absolute UNC path will be returned. Ie, instead of {\ttfamily \textquotesingle{}C\+:\textbackslash{}\textbackslash{}foo\textbackslash{}\textbackslash{}bar}, it would return {\ttfamily //?/C\+:/foo/bar}.\hypertarget{README.md_autotoc_md16133}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async path.\+readdir()}}{{\ttfamily async path.\+readdir()}}}\label{README.md_autotoc_md16133}
Return an array of {\ttfamily Path} objects found by reading the associated path entry.

If path is not a directory, or if any error occurs, returns {\ttfamily \mbox{[}\mbox{]}}, and marks all children as provisional and non-\/existent.\hypertarget{README.md_autotoc_md16134}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+readdir\+Sync()}}{{\ttfamily path.\+readdir\+Sync()}}}\label{README.md_autotoc_md16134}
Synchronous {\ttfamily path.\+readdir()}\hypertarget{README.md_autotoc_md16135}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async path.\+readlink()}}{{\ttfamily async path.\+readlink()}}}\label{README.md_autotoc_md16135}
Return the {\ttfamily Path} object referenced by the {\ttfamily path} as a symbolic link.

If the {\ttfamily path} is not a symbolic link, or any error occurs, returns {\ttfamily undefined}.\hypertarget{README.md_autotoc_md16136}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+readlink\+Sync()}}{{\ttfamily path.\+readlink\+Sync()}}}\label{README.md_autotoc_md16136}
Synchronous {\ttfamily path.\+readlink()}\hypertarget{README.md_autotoc_md16137}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async path.\+lstat()}}{{\ttfamily async path.\+lstat()}}}\label{README.md_autotoc_md16137}
Call {\ttfamily lstat} on the path object, and fill it in with details determined.

If path does not exist, or any other error occurs, returns {\ttfamily undefined}, and marks the path as "{}unknown"{} type.\hypertarget{README.md_autotoc_md16138}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+lstat\+Sync()}}{{\ttfamily path.\+lstat\+Sync()}}}\label{README.md_autotoc_md16138}
Synchronous {\ttfamily path.\+lstat()}\hypertarget{README.md_autotoc_md16139}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily async path.\+realpath()}}{{\ttfamily async path.\+realpath()}}}\label{README.md_autotoc_md16139}
Call {\ttfamily realpath} on the path, and return a Path object corresponding to the result, or {\ttfamily undefined} if any error occurs.\hypertarget{README.md_autotoc_md16140}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily path.\+realpath\+Sync()}}{{\ttfamily path.\+realpath\+Sync()}}}\label{README.md_autotoc_md16140}
