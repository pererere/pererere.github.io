\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/karma/node\+\_\+modules/connect Directory Reference}
\hypertarget{dir_935fade5da58657445c25757d3a91c19}{}\label{dir_935fade5da58657445c25757d3a91c19}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/karma/node\_modules/connect Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/karma/node\_modules/connect Directory Reference}}
...
\href{https://npmjs.org/package/connect}{\texttt{ }} \href{https://npmjs.org/package/connect}{\texttt{ }} \href{https://travis-ci.org/senchalabs/connect}{\texttt{ }} \href{https://coveralls.io/r/senchalabs/connect?branch=master}{\texttt{ }}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12112}{}\doxysubsubsection{\texorpdfstring{Getting Started}{Getting Started}}\label{README.md_autotoc_md12112}
Connect is a simple framework to glue together various "{}middleware"{} to handle requests.\hypertarget{README.md_autotoc_md12113}{}\doxysubsubsubsection{\texorpdfstring{Install Connect}{Install Connect}}\label{README.md_autotoc_md12113}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ connect}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md12114}{}\doxysubsubsubsection{\texorpdfstring{Create an app}{Create an app}}\label{README.md_autotoc_md12114}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12115}{}\doxysubsubsubsection{\texorpdfstring{Use middleware}{Use middleware}}\label{README.md_autotoc_md12115}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12116}{}\doxysubsubsubsection{\texorpdfstring{Mount middleware}{Mount middleware}}\label{README.md_autotoc_md12116}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12117}{}\doxysubsubsubsection{\texorpdfstring{Error middleware}{Error middleware}}\label{README.md_autotoc_md12117}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12118}{}\doxysubsubsubsection{\texorpdfstring{Create a server from the app}{Create a server from the app}}\label{README.md_autotoc_md12118}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12119}{}\doxysubsubsection{\texorpdfstring{Middleware}{Middleware}}\label{README.md_autotoc_md12119}
...
Checkout \href{https://github.com/Raynos/http-framework/wiki/Modules}{\texttt{ http-\/framework}} for many other compatible middleware!\hypertarget{README.md_autotoc_md12120}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md12120}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12121}{}\doxysubsubsubsection{\texorpdfstring{app(req, res\mbox{[}, next\mbox{]})}{app(req, res\mbox{[}, next\mbox{]})}}\label{README.md_autotoc_md12121}
The {\ttfamily app} itself is a function. This is just an alias to {\ttfamily app.\+handle}.\hypertarget{README.md_autotoc_md12122}{}\doxysubsubsubsection{\texorpdfstring{app.\+handle(req, res\mbox{[}, out\mbox{]})}{app.\+handle(req, res\mbox{[}, out\mbox{]})}}\label{README.md_autotoc_md12122}
Calling the function will run the middleware stack against the given Node.\+js http request ({\ttfamily req}) and response ({\ttfamily res}) objects. An optional function {\ttfamily out} can be provided that will be called if the request (or error) was not handled by the middleware stack.\hypertarget{README.md_autotoc_md12123}{}\doxysubsubsubsection{\texorpdfstring{app.\+listen(\mbox{[}...\mbox{]})}{app.\+listen(\mbox{[}...\mbox{]})}}\label{README.md_autotoc_md12123}
...
This is an alias to the {\ttfamily server.\+listen()} method in the version of Node.\+js running, so consult the Node.\+js documentation for all the different variations. The most common signature is \href{https://nodejs.org/dist/latest-v6.x/docs/api/http.html\#http_server_listen_port_hostname_backlog_callback}{\texttt{ {\ttfamily app.\+listen(port)}}}.\hypertarget{README.md_autotoc_md12124}{}\doxysubsubsubsection{\texorpdfstring{app.\+use(fn)}{app.\+use(fn)}}\label{README.md_autotoc_md12124}
...
In addition to a plan function, the {\ttfamily fn} argument can also be a Node.\+js HTTP server instance or another Connect app instance.\hypertarget{README.md_autotoc_md12125}{}\doxysubsubsubsection{\texorpdfstring{app.\+use(route, fn)}{app.\+use(route, fn)}}\label{README.md_autotoc_md12125}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md12127}{}\doxysubsubsection{\texorpdfstring{People}{People}}\label{README.md_autotoc_md12127}
...
\href{https://github.com/senchalabs/connect/graphs/contributors}{\texttt{ List of all contributors}}\hypertarget{README.md_autotoc_md12128}{}\doxysubsubsection{\texorpdfstring{Node Compatibility}{Node Compatibility}}\label{README.md_autotoc_md12128}
...
\item Connect {\ttfamily \texorpdfstring{$>$}{>}= 3} -\/ node {\ttfamily 0.\+10}, {\ttfamily 0.\+12}, {\ttfamily 4.\+x}, {\ttfamily 5.\+x}, {\ttfamily 6.\+x}, {\ttfamily 7.\+x}, {\ttfamily 8.\+x}, {\ttfamily 9.\+x}, {\ttfamily 10.\+x}, {\ttfamily 11.\+x}, {\ttfamily 12.\+x}; io.\+js {\ttfamily 1.\+x}, {\ttfamily 2.\+x}, {\ttfamily 3.\+x}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md12129}{}\doxysubsubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md12129}
