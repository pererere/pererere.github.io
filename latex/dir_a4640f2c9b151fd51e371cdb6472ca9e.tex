\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/htmlparser2 Directory Reference}
\hypertarget{dir_a4640f2c9b151fd51e371cdb6472ca9e}{}\label{dir_a4640f2c9b151fd51e371cdb6472ca9e}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/htmlparser2 Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/htmlparser2 Directory Reference}}
...
{\itshape htmlparser2 is the fastest HTML parser, and takes some shortcuts to get there. If you need strict HTML spec compliance, have a look at \href{https://github.com/inikulin/parse5}{\texttt{ parse5}}.}\hypertarget{README.md_autotoc_md8766}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md8766}
\begin{DoxyVerb}npm install htmlparser2
\end{DoxyVerb}


A live demo of {\ttfamily htmlparser2} is available \href{https://astexplorer.net/\#/2AmVrGuGVJ}{\texttt{ on AST Explorer}}.\hypertarget{README.md_autotoc_md8767}{}\doxysubsection{\texorpdfstring{Ecosystem}{Ecosystem}}\label{README.md_autotoc_md8767}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{README.md_autotoc_md8768}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md8768}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8770}{}\doxysubsection{\texorpdfstring{Getting a DOM}{Getting a DOM}}\label{README.md_autotoc_md8770}
...
Note\+: While the provided feed handler works for most feeds, you might want to use \href{https://github.com/danmactough/node-feedparser}{\texttt{ danmactough/node-\/feedparser}}, which is much better tested and actively maintained.\hypertarget{README.md_autotoc_md8772}{}\doxysubsection{\texorpdfstring{Performance}{Performance}}\label{README.md_autotoc_md8772}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8773}{}\doxysubsection{\texorpdfstring{How does this module differ from \href{https://github.com/tautologistics/node-htmlparser}{\texttt{ node-\/htmlparser}}?}{How does this module differ from \href{https://github.com/tautologistics/node-htmlparser}{\texttt{ node-\/htmlparser}}?}}\label{README.md_autotoc_md8773}
...
The {\ttfamily Rss\+Handler} was replaced with a {\ttfamily get\+Feed} function that takes a {\ttfamily Dom\+Handler} DOM and returns a feed object. There is a {\ttfamily parse\+Feed} helper function that can be used to parse a feed from a string.\hypertarget{README.md_autotoc_md8774}{}\doxysubsection{\texorpdfstring{Security contact information}{Security contact information}}\label{README.md_autotoc_md8774}
To report a security vulnerability, please use the \href{https://tidelift.com/security}{\texttt{ Tidelift security contact}}. Tidelift will coordinate the fix and disclosure.\hypertarget{README.md_autotoc_md8775}{}\doxysubsection{\texorpdfstring{{\ttfamily htmlparser2} for enterprise}{{\ttfamily htmlparser2} for enterprise}}\label{README.md_autotoc_md8775}
