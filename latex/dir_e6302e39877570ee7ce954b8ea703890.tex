\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/ipaddr.js Directory Reference}
\hypertarget{dir_e6302e39877570ee7ce954b8ea703890}{}\label{dir_e6302e39877570ee7ce954b8ea703890}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/ipaddr.js Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/ipaddr.js Directory Reference}}
...
ipaddr.\+js allows you to verify and parse string representation of an IP address, match it against a CIDR range or range list, determine if it falls into some reserved ranges (examples include loopback and private ranges), and convert between IPv4 and IPv4-\/mapped IPv6 addresses.\hypertarget{README.md_autotoc_md9528}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md9528}
{\ttfamily npm install ipaddr.\+js}

or

{\ttfamily bower install ipaddr.\+js}\hypertarget{README.md_autotoc_md9529}{}\doxysubsection{\texorpdfstring{Older Node support}{Older Node support}}\label{README.md_autotoc_md9529}
Use 2.\+x release for nodejs versions 10+. Use the 1.\+x release for versions of nodejs older than 10.\hypertarget{README.md_autotoc_md9530}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md9530}
...
The API consists of several global methods and two classes\+: ipaddr.\+IPv6 and ipaddr.\+IPv4.\hypertarget{README.md_autotoc_md9531}{}\doxysubsubsection{\texorpdfstring{Global methods}{Global methods}}\label{README.md_autotoc_md9531}
...
The {\ttfamily ipaddr.\+process} method works just like the {\ttfamily ipaddr.\+parse} one, but it automatically converts IPv4-\/mapped IPv6 addresses to their IPv4 counterparts before returning. It is useful when you have a Node.\+js instance listening on an IPv6 socket, and the {\ttfamily net.\+ivp6.\+bindv6only} sysctl parameter (or its equivalent on non-\/\+Linux OS) is set to 0. In this case, you can accept IPv4 connections on your IPv6-\/only socket, but the remote address will be mangled. Use {\ttfamily ipaddr.\+process} method to automatically demangle it.\hypertarget{README.md_autotoc_md9532}{}\doxysubsubsection{\texorpdfstring{Object representation}{Object representation}}\label{README.md_autotoc_md9532}
Parsing methods return an object which descends from {\ttfamily ipaddr.\+IPv6} or {\ttfamily ipaddr.\+IPv4}. These objects share some properties, but most of them differ.\hypertarget{README.md_autotoc_md9533}{}\doxysubsubsubsection{\texorpdfstring{Shared properties}{Shared properties}}\label{README.md_autotoc_md9533}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9535}{}\doxysubsubsubsection{\texorpdfstring{IPv4 properties}{IPv4 properties}}\label{README.md_autotoc_md9535}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md9536}{}\doxysubsubsubsection{\texorpdfstring{Conversion}{Conversion}}\label{README.md_autotoc_md9536}
