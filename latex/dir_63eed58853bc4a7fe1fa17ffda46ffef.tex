\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/flat-\/cache Directory Reference}
\hypertarget{dir_63eed58853bc4a7fe1fa17ffda46ffef}{}\label{dir_63eed58853bc4a7fe1fa17ffda46ffef}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/flat-\/cache Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/flat-\/cache Directory Reference}}
...
\href{https://npmjs.org/package/flat-cache}{\texttt{ }} \href{https://github.com/jaredwray/flat-cache/actions/workflows/tests.yaml}{\texttt{ }} \href{https://codecov.io/github/jaredwray/flat-cache}{\texttt{ }} \href{https://npmjs.com/package/flat-cache}{\texttt{ }}\hypertarget{README.md_autotoc_md8037}{}\doxysubsection{\texorpdfstring{install}{install}}\label{README.md_autotoc_md8037}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ i\ -\/-\/save\ flat-\/cache}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md8038}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md8038}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8039}{}\doxysubsection{\texorpdfstring{Motivation for this module}{Motivation for this module}}\label{README.md_autotoc_md8039}
I needed a super simple and dumb {\bfseries{in-\/memory cache}} with optional disk persistance in order to make a script that will beutify files with {\ttfamily esformatter} only execute on the files that were changed since the last run. To make that possible we need to store the {\ttfamily file\+Size} and {\ttfamily modification\+Time} of the files. So a simple {\ttfamily key/value} storage was needed and Bam! this module was born.\hypertarget{README.md_autotoc_md8040}{}\doxysubsection{\texorpdfstring{Important notes}{Important notes}}\label{README.md_autotoc_md8040}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md8041}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md8041}
MIT\hypertarget{README.md_autotoc_md8042}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{README.md_autotoc_md8042}
\doxysectlink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2flat-cache_2changelog}{changelog}{0} 