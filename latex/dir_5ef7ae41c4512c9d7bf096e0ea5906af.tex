\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/commander Directory Reference}
\hypertarget{dir_5ef7ae41c4512c9d7bf096e0ea5906af}{}\label{dir_5ef7ae41c4512c9d7bf096e0ea5906af}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/commander Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/commander Directory Reference}}
...
The complete solution for \href{http://nodejs.org}{\texttt{ node.\+js}} command-\/line interfaces, inspired by Ruby\textquotesingle{}s \href{https://github.com/commander-rb/commander}{\texttt{ commander}}. ~\newline
 \href{http://tj.github.com/commander.js/}{\texttt{ API documentation}}\hypertarget{Readme.md_autotoc_md4192}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{Readme.md_autotoc_md4192}
\begin{DoxyVerb}$ npm install commander
\end{DoxyVerb}
\hypertarget{Readme.md_autotoc_md4193}{}\doxysubsection{\texorpdfstring{Option parsing}{Option parsing}}\label{Readme.md_autotoc_md4193}
...
{\bfseries{NOTE}}\+: If you pass a argument without using brackets the example above will return true and not the value passed in.\hypertarget{Readme.md_autotoc_md4194}{}\doxysubsection{\texorpdfstring{Version option}{Version option}}\label{Readme.md_autotoc_md4194}
...
The version flags can be named anything, but the long option is required.\hypertarget{Readme.md_autotoc_md4195}{}\doxysubsection{\texorpdfstring{Command-\/specific options}{Command-\/specific options}}\label{Readme.md_autotoc_md4195}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md4197}{}\doxysubsection{\texorpdfstring{Regular Expression}{Regular Expression}}\label{Readme.md_autotoc_md4197}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md4198}{}\doxysubsection{\texorpdfstring{Variadic arguments}{Variadic arguments}}\label{Readme.md_autotoc_md4198}
...
\end{DoxyCode}
 Angled brackets (e.\+g. {\ttfamily \texorpdfstring{$<$}{<}cmd\texorpdfstring{$>$}{>}}) indicate required input. Square brackets (e.\+g. {\ttfamily \mbox{[}env\mbox{]}}) indicate optional input.\hypertarget{Readme.md_autotoc_md4200}{}\doxysubsection{\texorpdfstring{Git-\/style sub-\/commands}{Git-\/style sub-\/commands}}\label{Readme.md_autotoc_md4200}
...
If the program is designed to be installed globally, make sure the executables have proper modes, like {\ttfamily 755}.\hypertarget{Readme.md_autotoc_md4201}{}\doxysubsubsection{\texorpdfstring{{\ttfamily -\/-\/harmony}}{{\ttfamily -\/-\/harmony}}}\label{Readme.md_autotoc_md4201}
...
\end{DoxyItemize}\hypertarget{Readme.md_autotoc_md4202}{}\doxysubsection{\texorpdfstring{Automated --help}{Automated --help}}\label{Readme.md_autotoc_md4202}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md4203}{}\doxysubsection{\texorpdfstring{Custom help}{Custom help}}\label{Readme.md_autotoc_md4203}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md4204}{}\doxysubsection{\texorpdfstring{.output\+Help(cb)}{.output\+Help(cb)}}\label{Readme.md_autotoc_md4204}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md4205}{}\doxysubsection{\texorpdfstring{.help(cb)}{.help(cb)}}\label{Readme.md_autotoc_md4205}
Output help information and exit immediately. Optional callback cb allows post-\/processing of help text before it is displayed.\hypertarget{Readme.md_autotoc_md4206}{}\doxysubsection{\texorpdfstring{Custom event listeners}{Custom event listeners}}\label{Readme.md_autotoc_md4206}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md4207}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{Readme.md_autotoc_md4207}
...
More Demos can be found in the \href{https://github.com/tj/commander.js/tree/master/examples}{\texttt{ examples}} directory.\hypertarget{Readme.md_autotoc_md4208}{}\doxysubsection{\texorpdfstring{License}{License}}\label{Readme.md_autotoc_md4208}
