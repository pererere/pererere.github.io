\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/read-\/package-\/json-\/fast/node\+\_\+modules/json-\/parse-\/even-\/better-\/errors Directory Reference}
\hypertarget{dir_225a8ec1bb9219d9d1795e4079a3d562}{}\label{dir_225a8ec1bb9219d9d1795e4079a3d562}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/read-\/package-\/json-\/fast/node\_modules/json-\/parse-\/even-\/better-\/errors Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/read-\/package-\/json-\/fast/node\_modules/json-\/parse-\/even-\/better-\/errors Directory Reference}}
...
It also preserves the newline and indentation styles of the JSON data, by putting them in the object or array in the `Symbol.\+for(\textquotesingle{}indent'){\ttfamily and }Symbol.\+for(\textquotesingle{}newline\textquotesingle{})\`{} properties.\hypertarget{README.md_autotoc_md17139}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md17139}
{\ttfamily \$ npm install -\/-\/save json-\/parse-\/even-\/better-\/errors}\hypertarget{README.md_autotoc_md17140}{}\doxysubsection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{README.md_autotoc_md17140}
...
\item \`{}parse\`{}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md17141}{}\doxysubsubsection{\texorpdfstring{Example}{Example}}\label{README.md_autotoc_md17141}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md17142}{}\doxysubsubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md17142}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md17143}{}\doxysubsection{\texorpdfstring{Indentation}{Indentation}}\label{README.md_autotoc_md17143}
...
Indentation is determined by looking at the whitespace between the initial {\ttfamily \{} and {\ttfamily \mbox{[}} and the character that follows it. If you have lots of weird inconsistent indentation, then it won\textquotesingle{}t track that or give you any way to preserve it. Whether this is a bug or a feature is debatable ;)\hypertarget{README.md_autotoc_md17144}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md17144}
\hypertarget{README.md_autotoc_md17145}{}\doxysubsubsubsection{\texorpdfstring{\label{_parse}%
 {\ttfamily parse(txt, reviver = null, context = 20)}}{\label{_parse}%
 {\ttfamily parse(txt, reviver = null, context = 20)}}}\label{README.md_autotoc_md17145}
Works just like {\ttfamily JSON.\+parse}, but will include a bit more information when an error happens, and attaches a `Symbol.\+for(\textquotesingle{}indent'){\ttfamily and }Symbol.\+for(\textquotesingle{}newline\textquotesingle{}){\ttfamily on objects and arrays. This throws a }JSONParse\+Error\`{}.\hypertarget{README.md_autotoc_md17146}{}\doxysubsubsubsection{\texorpdfstring{\label{_parse}%
 {\ttfamily parse.\+no\+Exceptions(txt, reviver = null)}}{\label{_parse}%
 {\ttfamily parse.\+no\+Exceptions(txt, reviver = null)}}}\label{README.md_autotoc_md17146}
Works just like {\ttfamily JSON.\+parse}, but will return {\ttfamily undefined} rather than throwing an error.\hypertarget{README.md_autotoc_md17147}{}\doxysubsubsubsection{\texorpdfstring{\label{_jsonparseerror}%
 {\ttfamily class JSONParse\+Error(er, text, context = 20, caller = null)}}{\label{_jsonparseerror}%
 {\ttfamily class JSONParse\+Error(er, text, context = 20, caller = null)}}}\label{README.md_autotoc_md17147}
