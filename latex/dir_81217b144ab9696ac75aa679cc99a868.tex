\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/tar Directory Reference}
\hypertarget{dir_81217b144ab9696ac75aa679cc99a868}{}\label{dir_81217b144ab9696ac75aa679cc99a868}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/tar Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/tar Directory Reference}}


\doxysubsection{Detailed Description}
Fast and full-\/featured Tar for Node.\+js

The API is designed to mimic the behavior of {\ttfamily tar(1)} on unix systems. If you are familiar with how tar works, most of this will hopefully be straightforward for you. If not, then hopefully this module can teach you useful unix skills that may come in handy someday \+:)\hypertarget{README.md_autotoc_md20328}{}\doxysubsection{\texorpdfstring{Background}{Background}}\label{README.md_autotoc_md20328}
...
The other flags and options modify how this top level function works.\hypertarget{README.md_autotoc_md20329}{}\doxysubsection{\texorpdfstring{High-\/\+Level API}{High-\/\+Level API}}\label{README.md_autotoc_md20329}
...
Sync commands without a file argument return a stream that acts on its input immediately in the same tick. For readable streams, this means that all of the data is immediately available by calling {\ttfamily stream.\+read()}. For writable streams, it will be acted upon as soon as it is provided, but this can be at any time.\hypertarget{README.md_autotoc_md20330}{}\doxysubsubsection{\texorpdfstring{Warnings and Errors}{Warnings and Errors}}\label{README.md_autotoc_md20330}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20331}{}\doxysubsubsubsection{\texorpdfstring{Error Codes}{Error Codes}}\label{README.md_autotoc_md20331}
...
Keep reading for all the command descriptions and options, as well as the low-\/level API that they are built on.\hypertarget{README.md_autotoc_md20333}{}\doxysubsubsection{\texorpdfstring{tar.\+c(options, file\+List, callback) \mbox{[}alias\+: tar.\+create\mbox{]}}{tar.\+c(options, file\+List, callback) \mbox{[}alias\+: tar.\+create\mbox{]}}}\label{README.md_autotoc_md20333}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20334}{}\doxysubsubsection{\texorpdfstring{tar.\+x(options, file\+List, callback) \mbox{[}alias\+: tar.\+extract\mbox{]}}{tar.\+x(options, file\+List, callback) \mbox{[}alias\+: tar.\+extract\mbox{]}}}\label{README.md_autotoc_md20334}
...
Note that using an asynchronous stream type with the {\ttfamily transform} option will cause undefined behavior in sync extractions. \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}-\/based streams are designed for this use case.\hypertarget{README.md_autotoc_md20335}{}\doxysubsubsection{\texorpdfstring{tar.\+t(options, file\+List, callback) \mbox{[}alias\+: tar.\+list\mbox{]}}{tar.\+t(options, file\+List, callback) \mbox{[}alias\+: tar.\+list\mbox{]}}}\label{README.md_autotoc_md20335}
...
\item {\ttfamily onwarn} A function that will get called with {\ttfamily (code, message, data)} for any warnings encountered. (See "{}\+Warnings and Errors"{})
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20336}{}\doxysubsubsection{\texorpdfstring{tar.\+u(options, file\+List, callback) \mbox{[}alias\+: tar.\+update\mbox{]}}{tar.\+u(options, file\+List, callback) \mbox{[}alias\+: tar.\+update\mbox{]}}}\label{README.md_autotoc_md20336}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20337}{}\doxysubsubsection{\texorpdfstring{tar.\+r(options, file\+List, callback) \mbox{[}alias\+: tar.\+replace\mbox{]}}{tar.\+r(options, file\+List, callback) \mbox{[}alias\+: tar.\+replace\mbox{]}}}\label{README.md_autotoc_md20337}
...
\item {\ttfamily no\+Mtime} Set to true to omit writing {\ttfamily mtime} values for entries. Note that this prevents using other mtime-\/based features like {\ttfamily tar.\+update} or the {\ttfamily keep\+Newer} option with the resulting tar archive. \mbox{[}Alias\+: {\ttfamily m}, {\ttfamily no-\/mtime}\mbox{]}
\item {\ttfamily mtime} Set to a {\ttfamily Date} object to force a specific {\ttfamily mtime} for everything added to the archive. Overridden by {\ttfamily no\+Mtime}.
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20338}{}\doxysubsection{\texorpdfstring{Low-\/\+Level API}{Low-\/\+Level API}}\label{README.md_autotoc_md20338}
\hypertarget{README.md_autotoc_md20339}{}\doxysubsubsection{\texorpdfstring{class tar.\+Pack}{class tar.\+Pack}}\label{README.md_autotoc_md20339}
A readable tar stream.

Has all the standard readable stream interface stuff. `\textquotesingle{}data'{\ttfamily and }\textquotesingle{}end\textquotesingle{}{\ttfamily events,}read(){\ttfamily method,}pause(){\ttfamily and}resume()\`{}, etc.\hypertarget{README.md_autotoc_md20340}{}\doxysubsubsubsection{\texorpdfstring{constructor(options)}{constructor(options)}}\label{README.md_autotoc_md20340}
The following options are supported\+:
...
\item {\ttfamily mtime} Set to a {\ttfamily Date} object to force a specific {\ttfamily mtime} for everything added to the archive. Overridden by {\ttfamily no\+Mtime}.
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20341}{}\doxysubsubsubsection{\texorpdfstring{add(path)}{add(path)}}\label{README.md_autotoc_md20341}
Adds an entry to the archive. Returns the Pack stream.\hypertarget{README.md_autotoc_md20342}{}\doxysubsubsubsection{\texorpdfstring{write(path)}{write(path)}}\label{README.md_autotoc_md20342}
Adds an entry to the archive. Returns true if flushed.\hypertarget{README.md_autotoc_md20343}{}\doxysubsubsubsection{\texorpdfstring{end()}{end()}}\label{README.md_autotoc_md20343}
Finishes the archive.\hypertarget{README.md_autotoc_md20344}{}\doxysubsubsection{\texorpdfstring{class tar.\+Pack.\+Sync}{class tar.\+Pack.\+Sync}}\label{README.md_autotoc_md20344}
Synchronous version of {\ttfamily tar.\+Pack}.\hypertarget{README.md_autotoc_md20345}{}\doxysubsubsection{\texorpdfstring{class tar.\+Unpack}{class tar.\+Unpack}}\label{README.md_autotoc_md20345}
...
Most unpack errors will cause a {\ttfamily warn} event to be emitted. If the {\ttfamily cwd} is missing, or not a directory, then an error will be emitted.\hypertarget{README.md_autotoc_md20346}{}\doxysubsubsubsection{\texorpdfstring{constructor(options)}{constructor(options)}}\label{README.md_autotoc_md20346}
...
\item {\ttfamily no\+Chmod} Set to true to omit calling {\ttfamily fs.\+chmod()} to ensure that the extracted file matches the entry mode. This also suppresses the call to {\ttfamily process.\+umask()} to determine the default umask value, since tar will extract with whatever mode is provided, and let the process {\ttfamily umask} apply normally.
\item {\ttfamily max\+Depth} The maximum depth of subfolders to extract into. This defaults to 1024. Anything deeper than the limit will raise a warning and skip the entry. Set to {\ttfamily Infinity} to remove the limitation.
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20347}{}\doxysubsubsection{\texorpdfstring{class tar.\+Unpack.\+Sync}{class tar.\+Unpack.\+Sync}}\label{README.md_autotoc_md20347}
Synchronous version of {\ttfamily tar.\+Unpack}.

Note that using an asynchronous stream type with the {\ttfamily transform} option will cause undefined behavior in sync unpack streams. \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}-\/based streams are designed for this use case.\hypertarget{README.md_autotoc_md20348}{}\doxysubsubsection{\texorpdfstring{class tar.\+Parse}{class tar.\+Parse}}\label{README.md_autotoc_md20348}
...
Each {\ttfamily entry} will not emit until the one before it is flushed through, so make sure to either consume the data (with `on(\textquotesingle{}data', ...){\ttfamily or }.pipe(...){\ttfamily ) or throw it away with}.resume()\`{} to keep the stream flowing.\hypertarget{README.md_autotoc_md20349}{}\doxysubsubsubsection{\texorpdfstring{constructor(options)}{constructor(options)}}\label{README.md_autotoc_md20349}
...
\item {\ttfamily onentry} A function that gets called with {\ttfamily (entry)} for each entry that passes the filter.
\item {\ttfamily onwarn} A function that will get called with {\ttfamily (code, message, data)} for any warnings encountered. (See "{}\+Warnings and Errors"{})
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20350}{}\doxysubsubsubsection{\texorpdfstring{abort(error)}{abort(error)}}\label{README.md_autotoc_md20350}
Stop all parsing activities. This is called when there are zlib errors. It also emits an unrecoverable warning with the error provided.\hypertarget{README.md_autotoc_md20351}{}\doxysubsubsection{\texorpdfstring{class tar.\+Read\+Entry extends \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}}{class tar.\+Read\+Entry extends \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}}}\label{README.md_autotoc_md20351}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20352}{}\doxysubsubsubsection{\texorpdfstring{constructor(header, extended, global\+Extended)}{constructor(header, extended, global\+Extended)}}\label{README.md_autotoc_md20352}
Create a new Read\+Entry object with the specified header, extended header, and global extended header values.\hypertarget{README.md_autotoc_md20353}{}\doxysubsubsection{\texorpdfstring{class tar.\+Write\+Entry extends \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}}{class tar.\+Write\+Entry extends \href{http://npm.im/minipass}{\texttt{ Mini\+Pass}}}}\label{README.md_autotoc_md20353}
...
\item {\ttfamily no\+Pax} Suppress pax extended headers. Note that this means that long paths and linkpaths will be truncated, and large or negative numeric values may be interpreted incorrectly.
\item {\ttfamily no\+Mtime} Set to true to omit writing {\ttfamily mtime} values for entries. Note that this prevents using other mtime-\/based features like {\ttfamily tar.\+update} or the {\ttfamily keep\+Newer} option with the resulting tar archive.
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20354}{}\doxysubsubsubsection{\texorpdfstring{constructor(path, options)}{constructor(path, options)}}\label{README.md_autotoc_md20354}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20355}{}\doxysubsubsubsection{\texorpdfstring{warn(message, data)}{warn(message, data)}}\label{README.md_autotoc_md20355}
If strict, emit an error with the provided message.

Othewise, emit a `\textquotesingle{}warn'\`{} event with the provided message and data.\hypertarget{README.md_autotoc_md20356}{}\doxysubsubsection{\texorpdfstring{class tar.\+Write\+Entry.\+Sync}{class tar.\+Write\+Entry.\+Sync}}\label{README.md_autotoc_md20356}
Synchronous version of tar.\+Write\+Entry\hypertarget{README.md_autotoc_md20357}{}\doxysubsubsection{\texorpdfstring{class tar.\+Write\+Entry.\+Tar}{class tar.\+Write\+Entry.\+Tar}}\label{README.md_autotoc_md20357}
A version of tar.\+Write\+Entry that gets its data from a tar.\+Read\+Entry instead of from the filesystem.\hypertarget{README.md_autotoc_md20358}{}\doxysubsubsubsection{\texorpdfstring{constructor(read\+Entry, options)}{constructor(read\+Entry, options)}}\label{README.md_autotoc_md20358}
...
\item {\ttfamily onwarn} A function that will get called with {\ttfamily (code, message, data)} for any warnings encountered. (See "{}\+Warnings and Errors"{})
\item {\ttfamily no\+Mtime} Set to true to omit writing {\ttfamily mtime} values for entries. Note that this prevents using other mtime-\/based features like {\ttfamily tar.\+update} or the {\ttfamily keep\+Newer} option with the resulting tar archive.
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20359}{}\doxysubsubsection{\texorpdfstring{class tar.\+Header}{class tar.\+Header}}\label{README.md_autotoc_md20359}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20360}{}\doxysubsubsubsection{\texorpdfstring{constructor(data, \mbox{[}offset=0\mbox{]})}{constructor(data, \mbox{[}offset=0\mbox{]})}}\label{README.md_autotoc_md20360}
{\ttfamily data} is optional. It is either a Buffer that should be interpreted as a tar Header starting at the specified offset and continuing for 512 bytes, or a data object of keys and values to set on the header object, and eventually encode as a tar Header.\hypertarget{README.md_autotoc_md20361}{}\doxysubsubsubsection{\texorpdfstring{decode(block, offset)}{decode(block, offset)}}\label{README.md_autotoc_md20361}
Decode the provided buffer starting at the specified offset.

Buffer length must be greater than 512 bytes.\hypertarget{README.md_autotoc_md20362}{}\doxysubsubsubsection{\texorpdfstring{set(data)}{set(data)}}\label{README.md_autotoc_md20362}
Set the fields in the data object.\hypertarget{README.md_autotoc_md20363}{}\doxysubsubsubsection{\texorpdfstring{encode(buffer, offset)}{encode(buffer, offset)}}\label{README.md_autotoc_md20363}
Encode the header fields into the buffer at the specified offset.

Returns {\ttfamily this.\+need\+Pax} to indicate whether a Pax Extended Header is required to properly encode the specified data.\hypertarget{README.md_autotoc_md20364}{}\doxysubsubsection{\texorpdfstring{class tar.\+Pax}{class tar.\+Pax}}\label{README.md_autotoc_md20364}
...
\item {\ttfamily ino}
\item {\ttfamily nlink}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md20365}{}\doxysubsubsubsection{\texorpdfstring{constructor(object, global)}{constructor(object, global)}}\label{README.md_autotoc_md20365}
Set the fields set in the object. {\ttfamily global} is a boolean that defaults to false.\hypertarget{README.md_autotoc_md20366}{}\doxysubsubsubsection{\texorpdfstring{encode()}{encode()}}\label{README.md_autotoc_md20366}
Return a Buffer containing the header and body for the Pax extended header entry, or {\ttfamily null} if there is nothing to encode.\hypertarget{README.md_autotoc_md20367}{}\doxysubsubsubsection{\texorpdfstring{encode\+Body()}{encode\+Body()}}\label{README.md_autotoc_md20367}
Return a string representing the body of the pax extended header entry.\hypertarget{README.md_autotoc_md20368}{}\doxysubsubsubsection{\texorpdfstring{encode\+Field(field\+Name)}{encode\+Field(field\+Name)}}\label{README.md_autotoc_md20368}
Return a string representing the key/value encoding for the specified field\+Name, or `'\textquotesingle{}\`{} if the field is unset.\hypertarget{README.md_autotoc_md20369}{}\doxysubsubsection{\texorpdfstring{tar.\+Pax.\+parse(string, extended, global)}{tar.\+Pax.\+parse(string, extended, global)}}\label{README.md_autotoc_md20369}
Return a new Pax object created by parsing the contents of the string provided.

If the {\ttfamily extended} object is set, then also add the fields from that object. (This is necessary because multiple metadata entries can occur in sequence.)\hypertarget{README.md_autotoc_md20370}{}\doxysubsubsection{\texorpdfstring{tar.\+types}{tar.\+types}}\label{README.md_autotoc_md20370}
A translation table for the {\ttfamily type} field in tar headers.\hypertarget{README.md_autotoc_md20371}{}\doxysubsubsubsection{\texorpdfstring{tar.\+types.\+name.\+get(code)}{tar.\+types.\+name.\+get(code)}}\label{README.md_autotoc_md20371}
Get the human-\/readable name for a given alphanumeric code.\hypertarget{README.md_autotoc_md20372}{}\doxysubsubsubsection{\texorpdfstring{tar.\+types.\+code.\+get(name)}{tar.\+types.\+code.\+get(name)}}\label{README.md_autotoc_md20372}
