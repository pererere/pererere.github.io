\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/safer-\/buffer Directory Reference}
\hypertarget{dir_2dc97f7590d83b6078eee24e8e23232e}{}\label{dir_2dc97f7590d83b6078eee24e8e23232e}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/safer-\/buffer Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/safer-\/buffer Directory Reference}}


\doxysubsection{Detailed Description}
Modern Buffer API polyfill without footguns, working on Node.\+js from 0.\+8 to current.\hypertarget{Readme.md_autotoc_md18378}{}\doxysubsection{\texorpdfstring{How to use?}{How to use?}}\label{Readme.md_autotoc_md18378}
...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.\hypertarget{Readme.md_autotoc_md18379}{}\doxysubsection{\texorpdfstring{Do I need it?}{Do I need it?}}\label{Readme.md_autotoc_md18379}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.\hypertarget{Readme.md_autotoc_md18380}{}\doxysubsection{\texorpdfstring{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}}\label{Readme.md_autotoc_md18380}
...
Also, {\ttfamily safer-\/buffer} discourages the usage of {\ttfamily .alloc\+Unsafe()}, which is often done by a mistake. It still supports it with an explicit concern barier, by placing it under `require(\textquotesingle{}safer-\/buffer/dangereous')\`{}.\hypertarget{Readme.md_autotoc_md18381}{}\doxysubsection{\texorpdfstring{But isn\textquotesingle{}t throwing bad?}{But isn\textquotesingle{}t throwing bad?}}\label{Readme.md_autotoc_md18381}
...
New commits, if tested, won\textquotesingle{}t land new usage of unsafe Buffer API this way. {\itshape Node.\+js 10.\+x also deals with that by printing a runtime depecation warning.}\hypertarget{Readme.md_autotoc_md18382}{}\doxysubsubsection{\texorpdfstring{Would it affect third-\/party modules?}{Would it affect third-\/party modules?}}\label{Readme.md_autotoc_md18382}
No, unless you explicitly do an awful thing like monkey-\/patching or overriding the built-\/in {\ttfamily Buffer}. Don\textquotesingle{}t do that.\hypertarget{Readme.md_autotoc_md18383}{}\doxysubsubsection{\texorpdfstring{But I don\textquotesingle{}t want throwing…}{But I don\textquotesingle{}t want throwing…}}\label{Readme.md_autotoc_md18383}
That is also fine!
...
Note that using a linter to catch accidential {\ttfamily Buffer} constructor usage in this case is strongly recommended. {\ttfamily Buffer} is not overriden in this usecase, so linters won\textquotesingle{}t get confused.\hypertarget{Readme.md_autotoc_md18384}{}\doxysubsection{\texorpdfstring{«\+Without footguns»?}{«\+Without footguns»?}}\label{Readme.md_autotoc_md18384}
