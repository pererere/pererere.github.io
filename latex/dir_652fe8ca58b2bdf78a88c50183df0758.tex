\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/jackspeak Directory Reference}
\hypertarget{dir_652fe8ca58b2bdf78a88c50183df0758}{}\label{dir_652fe8ca58b2bdf78a88c50183df0758}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/jackspeak Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/jackspeak Directory Reference}}
...
Unless otherwise noted, all methods return the object itself.\hypertarget{README.md_autotoc_md10206}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md10206}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10207}{}\doxysubsection{\texorpdfstring{{\ttfamily jack(options\+: Jack\+Options = \{\}) =\texorpdfstring{$>$}{>} Jack}}{{\ttfamily jack(options\+: Jack\+Options = \{\}) =\texorpdfstring{$>$}{>} Jack}}}\label{README.md_autotoc_md10207}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md10208}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+heading(text\+: string, level?\+: 1 \texorpdfstring{$\vert$}{|} 2 \texorpdfstring{$\vert$}{|} 3 \texorpdfstring{$\vert$}{|} 4 \texorpdfstring{$\vert$}{|} 5 \texorpdfstring{$\vert$}{|} 6)}}{{\ttfamily Jack.\+heading(text\+: string, level?\+: 1 \texorpdfstring{$\vert$}{|} 2 \texorpdfstring{$\vert$}{|} 3 \texorpdfstring{$\vert$}{|} 4 \texorpdfstring{$\vert$}{|} 5 \texorpdfstring{$\vert$}{|} 6)}}}\label{README.md_autotoc_md10208}
...
Headings level 1 and 2 will have a line of padding underneath them. Headings level 3 through 6 will not.\hypertarget{README.md_autotoc_md10209}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+description(text\+: string, \{ pre?\+: boolean \} = \{\})}}{{\ttfamily Jack.\+description(text\+: string, \{ pre?\+: boolean \} = \{\})}}}\label{README.md_autotoc_md10209}
Define a long string description, used in the {\ttfamily usage()} output.

If the {\ttfamily pre} option is set to {\ttfamily true}, then whitespace will not be normalized. However, if any line is too long for the width allotted, it will still be wrapped.\hypertarget{README.md_autotoc_md10210}{}\doxysubsection{\texorpdfstring{Option Definitions}{Option Definitions}}\label{README.md_autotoc_md10210}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md10211}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+flag(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+flag(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{README.md_autotoc_md10211}
...
If a boolean option named {\ttfamily no-\/\$\{option\+Name\}} with the same {\ttfamily multiple} setting is in the configuration, then that will be treated as a negating flag.\hypertarget{README.md_autotoc_md10212}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+flag\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+flag\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{README.md_autotoc_md10212}
Define one or more boolean array fields.\hypertarget{README.md_autotoc_md10213}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+num(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+num(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{README.md_autotoc_md10213}
Define one or more number fields. These will be set in the environment as a stringified number, and included in the {\ttfamily values} object as a number.\hypertarget{README.md_autotoc_md10214}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+num\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+num\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{README.md_autotoc_md10214}
Define one or more number list fields. These will be set in the environment as a delimited set of stringified numbers, and included in the {\ttfamily values} as a number array.\hypertarget{README.md_autotoc_md10215}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+opt(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+opt(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{README.md_autotoc_md10215}
Define one or more string option fields.\hypertarget{README.md_autotoc_md10216}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+opt\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+opt\+List(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{README.md_autotoc_md10216}
Define one or more string list fields.\hypertarget{README.md_autotoc_md10217}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+add\+Fields(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}{{\ttfamily Jack.\+add\+Fields(\{ \mbox{[}option\+: string\mbox{]}\+: definition, ... \})}}}\label{README.md_autotoc_md10217}
Define one or more fields of any type. Note that {\ttfamily type} and {\ttfamily multiple} must be set explicitly on each definition when using this method.\hypertarget{README.md_autotoc_md10218}{}\doxysubsection{\texorpdfstring{Actions}{Actions}}\label{README.md_autotoc_md10218}
Use these methods on a Jack object that\textquotesingle{}s already had its config fields defined.\hypertarget{README.md_autotoc_md10219}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+parse(args\+: string\mbox{[}\mbox{]} = process.\+argv)\+: \{ positionals\+: string\mbox{[}\mbox{]}, values\+: Options\+Results \}}}{{\ttfamily Jack.\+parse(args\+: string\mbox{[}\mbox{]} = process.\+argv)\+: \{ positionals\+: string\mbox{[}\mbox{]}, values\+: Options\+Results \}}}}\label{README.md_autotoc_md10219}
Parse the arguments list, write to the environment if {\ttfamily env\+Prefix} is set, and returned the parsed values and remaining positional arguments.\hypertarget{README.md_autotoc_md10220}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+validate(o\+: any)\+: asserts o is Options\+Results}}{{\ttfamily Jack.\+validate(o\+: any)\+: asserts o is Options\+Results}}}\label{README.md_autotoc_md10220}
Throws an error if the object provided is not a valid result set, for the configurations defined thusfar.\hypertarget{README.md_autotoc_md10221}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+usage()\+: string}}{{\ttfamily Jack.\+usage()\+: string}}}\label{README.md_autotoc_md10221}
Returns the compiled {\ttfamily usage} string, with all option descriptions and heading/description text, wrapped to the appropriate width for the terminal.\hypertarget{README.md_autotoc_md10222}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+set\+Config\+Values(options\+: Options\+Results, src?\+: string)}}{{\ttfamily Jack.\+set\+Config\+Values(options\+: Options\+Results, src?\+: string)}}}\label{README.md_autotoc_md10222}
Validate the {\ttfamily options} argument, and set the default value for each field that appears in the options.

Values provided will be overridden by environment variables or command line arguments.\hypertarget{README.md_autotoc_md10223}{}\doxysubsubsection{\texorpdfstring{{\ttfamily Jack.\+usage\+Markdown()\+: string}}{{\ttfamily Jack.\+usage\+Markdown()\+: string}}}\label{README.md_autotoc_md10223}
Returns the compiled {\ttfamily usage} string, with all option descriptions and heading/description text, but as markdown instead of formatted for a terminal, for generating HTML documentation for your CLI.\hypertarget{README.md_autotoc_md10224}{}\doxysubsection{\texorpdfstring{Some Example Code}{Some Example Code}}\label{README.md_autotoc_md10224}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10225}{}\doxysubsection{\texorpdfstring{Name}{Name}}\label{README.md_autotoc_md10225}
