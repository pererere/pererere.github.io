\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/etag Directory Reference}
\hypertarget{dir_e9ab1e3aafdd36947ab7c8c8c3900ce8}{}\label{dir_e9ab1e3aafdd36947ab7c8c8c3900ce8}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/etag Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/etag Directory Reference}}
...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{README.md_autotoc_md6760}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md6760}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6761}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md6761}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ etag\ =\ require('etag')}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md6762}{}\doxysubsubsection{\texorpdfstring{etag(entity, \mbox{[}options\mbox{]})}{etag(entity, \mbox{[}options\mbox{]})}}\label{README.md_autotoc_md6762}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6763}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md6763}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{README.md_autotoc_md6764}{}\doxysubsubsubsubsection{\texorpdfstring{weak}{weak}}\label{README.md_autotoc_md6764}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{README.md_autotoc_md6765}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md6765}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md6766}{}\doxysubsection{\texorpdfstring{Benchmark}{Benchmark}}\label{README.md_autotoc_md6766}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md6767}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md6767}
