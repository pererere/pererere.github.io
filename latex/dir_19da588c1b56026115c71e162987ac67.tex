\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/tapable Directory Reference}
\hypertarget{dir_19da588c1b56026115c71e162987ac67}{}\label{dir_19da588c1b56026115c71e162987ac67}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/tapable Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/tapable Directory Reference}}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20202}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md20202}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20203}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md20203}
...
This ensures fastest possible execution.\hypertarget{README.md_autotoc_md20204}{}\doxysubsection{\texorpdfstring{Hook types}{Hook types}}\label{README.md_autotoc_md20204}
...
The hook type is reflected in its class name. E.\+g., {\ttfamily Async\+Series\+Waterfall\+Hook} allows asynchronous functions and runs them in series, passing each function’s return value into the next function.\hypertarget{README.md_autotoc_md20205}{}\doxysubsection{\texorpdfstring{Interception}{Interception}}\label{README.md_autotoc_md20205}
...
{\bfseries{register}}\+: {\ttfamily (tap\+: Tap) =\texorpdfstring{$>$}{>} Tap \texorpdfstring{$\vert$}{|} undefined} Adding {\ttfamily register} to your interceptor will trigger for each added {\ttfamily Tap} and allows to modify it.\hypertarget{README.md_autotoc_md20206}{}\doxysubsection{\texorpdfstring{Context}{Context}}\label{README.md_autotoc_md20206}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20207}{}\doxysubsection{\texorpdfstring{Hook\+Map}{Hook\+Map}}\label{README.md_autotoc_md20207}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20208}{}\doxysubsection{\texorpdfstring{Hook/\+Hook\+Map interface}{Hook/\+Hook\+Map interface}}\label{README.md_autotoc_md20208}
Public\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md20209}{}\doxysubsection{\texorpdfstring{Multi\+Hook}{Multi\+Hook}}\label{README.md_autotoc_md20209}
