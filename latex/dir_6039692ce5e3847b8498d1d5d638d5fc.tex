\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/hosted-\/git-\/info/node\+\_\+modules/lru-\/cache Directory Reference}
\hypertarget{dir_6039692ce5e3847b8498d1d5d638d5fc}{}\label{dir_6039692ce5e3847b8498d1d5d638d5fc}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/hosted-\/git-\/info/node\_modules/lru-\/cache Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/hosted-\/git-\/info/node\_modules/lru-\/cache Directory Reference}}
...
If you put more stuff in the cache, then less recently used items will fall out. That\textquotesingle{}s what an LRU cache is.\hypertarget{README.md_autotoc_md8626}{}\doxysubsection{\texorpdfstring{{\ttfamily class LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}{{\ttfamily class LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}}\label{README.md_autotoc_md8626}
...
Some options are marked read-\/only because changing them after instantiation is not safe. Changing any of the other options will of course only have an effect on subsequent method calls.\hypertarget{README.md_autotoc_md8628}{}\doxysubsubsection{\texorpdfstring{{\ttfamily max} (read only)}{{\ttfamily max} (read only)}}\label{README.md_autotoc_md8628}
...
{\bfseries{It is strongly recommended to set a {\ttfamily max} to prevent unbounded growth of the cache.}} See "{}\+Storage Bounds Safety"{} below.\hypertarget{README.md_autotoc_md8629}{}\doxysubsubsection{\texorpdfstring{{\ttfamily max\+Size} (read only)}{{\ttfamily max\+Size} (read only)}}\label{README.md_autotoc_md8629}
...
Even if size tracking is enabled, {\bfseries{it is strongly recommended to set a {\ttfamily max} to prevent unbounded growth of the cache.}} See "{}\+Storage Bounds Safety"{} below.\hypertarget{README.md_autotoc_md8630}{}\doxysubsubsection{\texorpdfstring{{\ttfamily max\+Entry\+Size}}{{\ttfamily max\+Entry\+Size}}}\label{README.md_autotoc_md8630}
...
Optional, must be a positive integer if provided. Defaults to the value of {\ttfamily max\+Size} if provided.\hypertarget{README.md_autotoc_md8631}{}\doxysubsubsection{\texorpdfstring{{\ttfamily size\+Calculation}}{{\ttfamily size\+Calculation}}}\label{README.md_autotoc_md8631}
...
If the {\ttfamily size} (or return value of {\ttfamily size\+Calculation}) for a given entry is greater than {\ttfamily max\+Entry\+Size}, then the item will not be added to the cache.\hypertarget{README.md_autotoc_md8632}{}\doxysubsubsection{\texorpdfstring{{\ttfamily fetch\+Method} (read only)}{{\ttfamily fetch\+Method} (read only)}}\label{README.md_autotoc_md8632}
...
For example, a DNS cache may update the TTL based on the value returned from a remote DNS server by changing {\ttfamily options.\+ttl} in the {\ttfamily fetch\+Method}.\hypertarget{README.md_autotoc_md8633}{}\doxysubsubsection{\texorpdfstring{{\ttfamily no\+Delete\+On\+Fetch\+Rejection}}{{\ttfamily no\+Delete\+On\+Fetch\+Rejection}}}\label{README.md_autotoc_md8633}
...
This may be set in calls to {\ttfamily fetch()}, or defaulted on the constructor, or overridden by modifying the options object in the {\ttfamily fetch\+Method}.\hypertarget{README.md_autotoc_md8635}{}\doxysubsubsection{\texorpdfstring{{\ttfamily allow\+Stale\+On\+Fetch\+Abort}}{{\ttfamily allow\+Stale\+On\+Fetch\+Abort}}}\label{README.md_autotoc_md8635}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8636}{}\doxysubsubsection{\texorpdfstring{{\ttfamily ignore\+Fetch\+Abort}}{{\ttfamily ignore\+Fetch\+Abort}}}\label{README.md_autotoc_md8636}
...
This may be overridden on the {\ttfamily fetch()} call or in the {\ttfamily fetch\+Method} itself.\hypertarget{README.md_autotoc_md8637}{}\doxysubsubsection{\texorpdfstring{{\ttfamily dispose} (read only)}{{\ttfamily dispose} (read only)}}\label{README.md_autotoc_md8637}
...
Optional, must be a function.\hypertarget{README.md_autotoc_md8638}{}\doxysubsubsection{\texorpdfstring{{\ttfamily dispose\+After} (read only)}{{\ttfamily dispose\+After} (read only)}}\label{README.md_autotoc_md8638}
...
The {\ttfamily dispose\+After()} method is {\itshape not} called for canceled calls to {\ttfamily fetch\+Method()}. If you wish to handle evictions, overwrites, and deletes of in-\/flight asynchronous fetches, you must use the {\ttfamily Abort\+Signal} provided.\hypertarget{README.md_autotoc_md8639}{}\doxysubsubsection{\texorpdfstring{{\ttfamily no\+Dispose\+On\+Set}}{{\ttfamily no\+Dispose\+On\+Set}}}\label{README.md_autotoc_md8639}
...
Boolean, default {\ttfamily false}. Only relevant if {\ttfamily dispose} or {\ttfamily dispose\+After} options are set.\hypertarget{README.md_autotoc_md8640}{}\doxysubsubsection{\texorpdfstring{{\ttfamily ttl}}{{\ttfamily ttl}}}\label{README.md_autotoc_md8640}
...
Boolean, default false.\hypertarget{README.md_autotoc_md8642}{}\doxysubsubsection{\texorpdfstring{{\ttfamily ttl\+Resolution}}{{\ttfamily ttl\+Resolution}}}\label{README.md_autotoc_md8642}
...
Note that setting this to a higher value {\itshape will} improve performance somewhat while using ttl tracking, albeit at the expense of keeping stale items around a bit longer than intended.\hypertarget{README.md_autotoc_md8643}{}\doxysubsubsection{\texorpdfstring{{\ttfamily ttl\+Autopurge}}{{\ttfamily ttl\+Autopurge}}}\label{README.md_autotoc_md8643}
...
Boolean, default {\ttfamily false}\hypertarget{README.md_autotoc_md8644}{}\doxysubsubsection{\texorpdfstring{{\ttfamily allow\+Stale}}{{\ttfamily allow\+Stale}}}\label{README.md_autotoc_md8644}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{README.md_autotoc_md8645}{}\doxysubsubsection{\texorpdfstring{{\ttfamily no\+Delete\+On\+Stale\+Get}}{{\ttfamily no\+Delete\+On\+Stale\+Get}}}\label{README.md_autotoc_md8645}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{README.md_autotoc_md8646}{}\doxysubsubsection{\texorpdfstring{{\ttfamily update\+Age\+On\+Get}}{{\ttfamily update\+Age\+On\+Get}}}\label{README.md_autotoc_md8646}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{README.md_autotoc_md8647}{}\doxysubsubsection{\texorpdfstring{{\ttfamily update\+Age\+On\+Has}}{{\ttfamily update\+Age\+On\+Has}}}\label{README.md_autotoc_md8647}
...
Boolean, default false, only relevant if {\ttfamily ttl} is set.\hypertarget{README.md_autotoc_md8648}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md8648}
\hypertarget{README.md_autotoc_md8649}{}\doxysubsubsection{\texorpdfstring{{\ttfamily new LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}{{\ttfamily new LRUCache\texorpdfstring{$<$}{<}K, V, FC = unknown\texorpdfstring{$>$}{>}(options)}}}\label{README.md_autotoc_md8649}
...
Keys and values {\bfseries{must not}} be {\ttfamily null} or {\ttfamily undefined}.\hypertarget{README.md_autotoc_md8650}{}\doxysubsubsection{\texorpdfstring{{\ttfamily cache.\+max}, {\ttfamily cache.\+max\+Size}, {\ttfamily cache.\+allow\+Stale},}{{\ttfamily cache.\+max}, {\ttfamily cache.\+max\+Size}, {\ttfamily cache.\+allow\+Stale},}}\label{README.md_autotoc_md8650}
...
These are intended for read access only. Changing them during program operation can cause undefined behavior.\hypertarget{README.md_autotoc_md8651}{}\doxysubsubsection{\texorpdfstring{{\ttfamily cache.\+size}}{{\ttfamily cache.\+size}}}\label{README.md_autotoc_md8651}
The total number of items held in the cache at the current moment.\hypertarget{README.md_autotoc_md8652}{}\doxysubsubsection{\texorpdfstring{{\ttfamily cache.\+calculated\+Size}}{{\ttfamily cache.\+calculated\+Size}}}\label{README.md_autotoc_md8652}
The total size of items in cache when using size tracking.\hypertarget{README.md_autotoc_md8653}{}\doxysubsubsection{\texorpdfstring{{\ttfamily set(key, value, \mbox{[}\{ size, size\+Calculation, ttl, no\+Dispose\+On\+Set, start, status \}\mbox{]})}}{{\ttfamily set(key, value, \mbox{[}\{ size, size\+Calculation, ttl, no\+Dispose\+On\+Set, start, status \}\mbox{]})}}}\label{README.md_autotoc_md8653}
...
If the value is {\ttfamily undefined}, then this is an alias for {\ttfamily cache.\+delete(key)}. {\ttfamily undefined} is never stored in the cache. See {\bfseries{Storing Undefined Values}} below.\hypertarget{README.md_autotoc_md8654}{}\doxysubsubsection{\texorpdfstring{{\ttfamily get(key, \{ update\+Age\+On\+Get, allow\+Stale, status \} = \{\}) =\texorpdfstring{$>$}{>} value}}{{\ttfamily get(key, \{ update\+Age\+On\+Get, allow\+Stale, status \} = \{\}) =\texorpdfstring{$>$}{>} value}}}\label{README.md_autotoc_md8654}
...
For the usage of the {\ttfamily status} option, see {\bfseries{Status Tracking}} below.\hypertarget{README.md_autotoc_md8655}{}\doxysubsubsection{\texorpdfstring{{\ttfamily info(key) =\texorpdfstring{$>$}{>} Entry \texorpdfstring{$\vert$}{|} undefined}}{{\ttfamily info(key) =\texorpdfstring{$>$}{>} Entry \texorpdfstring{$\vert$}{|} undefined}}}\label{README.md_autotoc_md8655}
...
Note that stale values are always returned, rather than being pruned and treated as if they were not in the cache. If you wish to exclude stale entries, guard against a negative {\ttfamily ttl} value.\hypertarget{README.md_autotoc_md8656}{}\doxysubsubsection{\texorpdfstring{{\ttfamily async fetch(key, options = \{\}) =\texorpdfstring{$>$}{>} Promise}}{{\ttfamily async fetch(key, options = \{\}) =\texorpdfstring{$>$}{>} Promise}}}\label{README.md_autotoc_md8656}
...
If a {\ttfamily signal} is passed to the {\ttfamily fetch()} call, then aborting the signal will abort the fetch and cause the {\ttfamily fetch()} promise to reject with the reason provided.\hypertarget{README.md_autotoc_md8657}{}\doxysubsubsubsection{\texorpdfstring{Setting {\ttfamily context}}{Setting {\ttfamily context}}}\label{README.md_autotoc_md8657}
...
{\bfseries{1}}\+: Ie, they\textquotesingle{}re not the "{}same Promise"{}, but they resolve at the same time, because they\textquotesingle{}re both waiting on the same underlying fetch\+Method response.\hypertarget{README.md_autotoc_md8659}{}\doxysubsubsection{\texorpdfstring{{\ttfamily peek(key, \{ allow\+Stale \} = \{\}) =\texorpdfstring{$>$}{>} value}}{{\ttfamily peek(key, \{ allow\+Stale \} = \{\}) =\texorpdfstring{$>$}{>} value}}}\label{README.md_autotoc_md8659}
Like {\ttfamily get()} but doesn\textquotesingle{}t update recency or delete stale items.

Returns {\ttfamily undefined} if the item is stale, unless {\ttfamily allow\+Stale} is set either on the cache or in the options object.\hypertarget{README.md_autotoc_md8660}{}\doxysubsubsection{\texorpdfstring{{\ttfamily has(key, \{ update\+Age\+On\+Has, status \} = \{\}) =\texorpdfstring{$>$}{>} Boolean}}{{\ttfamily has(key, \{ update\+Age\+On\+Has, status \} = \{\}) =\texorpdfstring{$>$}{>} Boolean}}}\label{README.md_autotoc_md8660}
...
For the usage of the {\ttfamily status} option, see {\bfseries{Status Tracking}} below.\hypertarget{README.md_autotoc_md8661}{}\doxysubsubsection{\texorpdfstring{{\ttfamily delete(key)}}{{\ttfamily delete(key)}}}\label{README.md_autotoc_md8661}
Deletes a key out of the cache.

Returns {\ttfamily true} if the key was deleted, {\ttfamily false} otherwise.\hypertarget{README.md_autotoc_md8662}{}\doxysubsubsection{\texorpdfstring{{\ttfamily clear()}}{{\ttfamily clear()}}}\label{README.md_autotoc_md8662}
Clear the cache entirely, throwing away all values.\hypertarget{README.md_autotoc_md8663}{}\doxysubsubsection{\texorpdfstring{{\ttfamily keys()}}{{\ttfamily keys()}}}\label{README.md_autotoc_md8663}
Return a generator yielding the keys in the cache, in order from most recently used to least recently used.\hypertarget{README.md_autotoc_md8664}{}\doxysubsubsection{\texorpdfstring{{\ttfamily rkeys()}}{{\ttfamily rkeys()}}}\label{README.md_autotoc_md8664}
Return a generator yielding the keys in the cache, in order from least recently used to most recently used.\hypertarget{README.md_autotoc_md8665}{}\doxysubsubsection{\texorpdfstring{{\ttfamily values()}}{{\ttfamily values()}}}\label{README.md_autotoc_md8665}
Return a generator yielding the values in the cache, in order from most recently used to least recently used.\hypertarget{README.md_autotoc_md8666}{}\doxysubsubsection{\texorpdfstring{{\ttfamily rvalues()}}{{\ttfamily rvalues()}}}\label{README.md_autotoc_md8666}
Return a generator yielding the values in the cache, in order from least recently used to most recently used.\hypertarget{README.md_autotoc_md8667}{}\doxysubsubsection{\texorpdfstring{{\ttfamily entries()}}{{\ttfamily entries()}}}\label{README.md_autotoc_md8667}
Return a generator yielding {\ttfamily \mbox{[}key, value\mbox{]}} pairs, in order from most recently used to least recently used.\hypertarget{README.md_autotoc_md8668}{}\doxysubsubsection{\texorpdfstring{{\ttfamily rentries()}}{{\ttfamily rentries()}}}\label{README.md_autotoc_md8668}
Return a generator yielding {\ttfamily \mbox{[}key, value\mbox{]}} pairs, in order from least recently used to most recently used.\hypertarget{README.md_autotoc_md8669}{}\doxysubsubsection{\texorpdfstring{{\ttfamily find(fn, \mbox{[}get\+Options\mbox{]})}}{{\ttfamily find(fn, \mbox{[}get\+Options\mbox{]})}}}\label{README.md_autotoc_md8669}
...
The optional {\ttfamily get\+Options} are applied to the resulting {\ttfamily get()} of the item found.\hypertarget{README.md_autotoc_md8670}{}\doxysubsubsection{\texorpdfstring{{\ttfamily dump()}}{{\ttfamily dump()}}}\label{README.md_autotoc_md8670}
...
Note\+: this returns an actual array, not a generator, so it can be more easily passed around.\hypertarget{README.md_autotoc_md8671}{}\doxysubsubsection{\texorpdfstring{{\ttfamily load(entries)}}{{\ttfamily load(entries)}}}\label{README.md_autotoc_md8671}
...
The {\ttfamily start} fields are assumed to be calculated relative to a portable {\ttfamily Date.\+now()} timestamp, even if {\ttfamily performance.\+now()} is available.\hypertarget{README.md_autotoc_md8672}{}\doxysubsubsection{\texorpdfstring{{\ttfamily purge\+Stale()}}{{\ttfamily purge\+Stale()}}}\label{README.md_autotoc_md8672}
Delete any stale entries. Returns {\ttfamily true} if anything was removed, {\ttfamily false} otherwise.\hypertarget{README.md_autotoc_md8673}{}\doxysubsubsection{\texorpdfstring{{\ttfamily get\+Remaining\+TTL(key)}}{{\ttfamily get\+Remaining\+TTL(key)}}}\label{README.md_autotoc_md8673}
Return the number of ms left in the item\textquotesingle{}s TTL. If item is not in cache, returns {\ttfamily 0}. Returns {\ttfamily Infinity} if item is in cache without a defined TTL.\hypertarget{README.md_autotoc_md8674}{}\doxysubsubsection{\texorpdfstring{{\ttfamily for\+Each(fn, \mbox{[}thisp\mbox{]})}}{{\ttfamily for\+Each(fn, \mbox{[}thisp\mbox{]})}}}\label{README.md_autotoc_md8674}
...
If {\ttfamily thisp} is provided, function will be called in the {\ttfamily this}-\/context of the provided object.\hypertarget{README.md_autotoc_md8675}{}\doxysubsubsection{\texorpdfstring{{\ttfamily rfor\+Each(fn, \mbox{[}thisp\mbox{]})}}{{\ttfamily rfor\+Each(fn, \mbox{[}thisp\mbox{]})}}}\label{README.md_autotoc_md8675}
Same as {\ttfamily cache.\+for\+Each(fn, thisp)}, but in order from least recently used to most recently used.\hypertarget{README.md_autotoc_md8676}{}\doxysubsubsection{\texorpdfstring{{\ttfamily pop()}}{{\ttfamily pop()}}}\label{README.md_autotoc_md8676}
Evict the least recently used item, returning its value.

Returns {\ttfamily undefined} if cache is empty.\hypertarget{README.md_autotoc_md8677}{}\doxysubsection{\texorpdfstring{Status Tracking}{Status Tracking}}\label{README.md_autotoc_md8677}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8678}{}\doxysubsection{\texorpdfstring{Storage Bounds Safety}{Storage Bounds Safety}}\label{README.md_autotoc_md8678}
...
If that isn\textquotesingle{}t to your liking, check out \href{http://npm.im/@isaacs/ttlcache}{\texttt{ @isaacs/ttlcache}}.\hypertarget{README.md_autotoc_md8679}{}\doxysubsection{\texorpdfstring{Storing Undefined Values}{Storing Undefined Values}}\label{README.md_autotoc_md8679}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md8680}{}\doxysubsection{\texorpdfstring{Performance}{Performance}}\label{README.md_autotoc_md8680}
...
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md8681}{}\doxysubsection{\texorpdfstring{Breaking Changes in Version 7}{Breaking Changes in Version 7}}\label{README.md_autotoc_md8681}
...
If you were relying on the internals of LRUCache in version 6 or before, it probably will not work in version 7 and above.\hypertarget{README.md_autotoc_md8682}{}\doxysubsection{\texorpdfstring{Breaking Changes in Version 8}{Breaking Changes in Version 8}}\label{README.md_autotoc_md8682}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md8683}{}\doxysubsection{\texorpdfstring{Changes in Version 9}{Changes in Version 9}}\label{README.md_autotoc_md8683}
