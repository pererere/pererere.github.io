\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/serve-\/index/node\+\_\+modules/depd Directory Reference}
\hypertarget{dir_ac2ece4a65949bdcaff26ee56a95ddb7}{}\label{dir_ac2ece4a65949bdcaff26ee56a95ddb7}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/serve-\/index/node\_modules/depd Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/serve-\/index/node\_modules/depd Directory Reference}}
...
\hypertarget{Readme.md_autotoc_md18895}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{Readme.md_autotoc_md18895}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{Readme.md_autotoc_md18896}{}\doxysubsection{\texorpdfstring{API}{API}}\label{Readme.md_autotoc_md18896}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{Readme.md_autotoc_md18899}{}\doxysubsubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.\+function(fn, message)}}\label{Readme.md_autotoc_md18899}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{Readme.md_autotoc_md18900}{}\doxysubsubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.\+property(obj, prop, message)}}\label{Readme.md_autotoc_md18900}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18902}{}\doxysubsubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.\+env.\+NO\+\_\+\+DEPRECATION}}\label{Readme.md_autotoc_md18902}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{Readme.md_autotoc_md18903}{}\doxysubsubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.\+env.\+TRACE\+\_\+\+DEPRECATION}}\label{Readme.md_autotoc_md18903}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{Readme.md_autotoc_md18904}{}\doxysubsection{\texorpdfstring{Display}{Display}}\label{Readme.md_autotoc_md18904}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18905}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{Readme.md_autotoc_md18905}
\hypertarget{Readme.md_autotoc_md18906}{}\doxysubsubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{Readme.md_autotoc_md18906}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18907}{}\doxysubsubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{Readme.md_autotoc_md18907}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18908}{}\doxysubsubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{Readme.md_autotoc_md18908}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18909}{}\doxysubsection{\texorpdfstring{License}{License}}\label{Readme.md_autotoc_md18909}
