\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/retry Directory Reference}
\hypertarget{dir_c58049de8e9c8d6355cbf0e35a550e62}{}\label{dir_c58049de8e9c8d6355cbf0e35a550e62}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/retry Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/retry Directory Reference}}


\doxysubsection{Detailed Description}
\href{http://travis-ci.org/tim-kos/node-retry}{\texttt{ }} \href{https://codecov.io/gh/tim-kos/node-retry}{\texttt{ }}\hypertarget{README.md_autotoc_md17695}{}\doxysubsection{\texorpdfstring{retry}{retry}}\label{README.md_autotoc_md17695}
Abstraction for exponential and custom retry strategies for failed operations.\hypertarget{README.md_autotoc_md17696}{}\doxysubsubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md17696}
\begin{DoxyVerb}npm install retry
\end{DoxyVerb}
\hypertarget{README.md_autotoc_md17697}{}\doxysubsubsection{\texorpdfstring{Current Status}{Current Status}}\label{README.md_autotoc_md17697}
This module has been tested and is ready to be used.\hypertarget{README.md_autotoc_md17698}{}\doxysubsubsection{\texorpdfstring{Tutorial}{Tutorial}}\label{README.md_autotoc_md17698}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md17699}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md17699}
\hypertarget{README.md_autotoc_md17700}{}\doxysubsubsubsection{\texorpdfstring{retry.\+operation(\mbox{[}options\mbox{]})}{retry.\+operation(\mbox{[}options\mbox{]})}}\label{README.md_autotoc_md17700}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md17701}{}\doxysubsubsubsection{\texorpdfstring{retry.\+timeouts(\mbox{[}options\mbox{]})}{retry.\+timeouts(\mbox{[}options\mbox{]})}}\label{README.md_autotoc_md17701}
...
\texorpdfstring{$<$}{<}\href{http://www.wolframalpha.com/input/?i=Sum\%5B1000}{\texttt{ http\+://www.\+wolframalpha.\+com/input/?i=\+Sum\%5\+B1000}}\texorpdfstring{$\ast$}{*}x\texorpdfstring{$^\wedge$}{\string^}k\%2C+\{k\%2C+0\%2C+9\}\%5D+\%3D+5+\texorpdfstring{$\ast$}{*}+60+\texorpdfstring{$\ast$}{*}+1000\texorpdfstring{$>$}{>}\hypertarget{README.md_autotoc_md17702}{}\doxysubsubsubsection{\texorpdfstring{retry.\+create\+Timeout(attempt, opts)}{retry.\+create\+Timeout(attempt, opts)}}\label{README.md_autotoc_md17702}
...
{\ttfamily retry.\+create\+Timeout()} is used internally by {\ttfamily retry.\+timeouts()} and is public for you to be able to create your own timeouts for reinserting an item, see \href{https://github.com/tim-kos/node-retry/issues/13}{\texttt{ issue \#13}}.\hypertarget{README.md_autotoc_md17703}{}\doxysubsubsubsection{\texorpdfstring{retry.\+wrap(obj, \mbox{[}options\mbox{]}, \mbox{[}method\+Names\mbox{]})}{retry.\+wrap(obj, \mbox{[}options\mbox{]}, \mbox{[}method\+Names\mbox{]})}}\label{README.md_autotoc_md17703}
...
\end{DoxyCode}
 The {\ttfamily options} object can take any options that the usual call to {\ttfamily retry.\+operation} can take.\hypertarget{README.md_autotoc_md17704}{}\doxysubsubsubsection{\texorpdfstring{new Retry\+Operation(timeouts, \mbox{[}options\mbox{]})}{new Retry\+Operation(timeouts, \mbox{[}options\mbox{]})}}\label{README.md_autotoc_md17704}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md17705}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+errors()}{retry\+Operation.\+errors()}}\label{README.md_autotoc_md17705}
Returns an array of all errors that have been passed to {\ttfamily retry\+Operation.\+retry()} so far. The returning array has the errors ordered chronologically based on when they were passed to {\ttfamily retry\+Operation.\+retry()}, which means the first passed error is at index zero and the last is at the last index.\hypertarget{README.md_autotoc_md17706}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+main\+Error()}{retry\+Operation.\+main\+Error()}}\label{README.md_autotoc_md17706}
...
If no errors occured so far, the value is {\ttfamily null}.\hypertarget{README.md_autotoc_md17707}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+attempt(fn, timeout\+Ops)}{retry\+Operation.\+attempt(fn, timeout\+Ops)}}\label{README.md_autotoc_md17707}
...
Optionally defines {\ttfamily timeout\+Ops} which is an object having a property {\ttfamily timeout} in miliseconds and a property {\ttfamily cb} callback function. Whenever your retry operation takes longer than {\ttfamily timeout} to execute, the timeout callback function {\ttfamily cb} is called.\hypertarget{README.md_autotoc_md17708}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+try(fn)}{retry\+Operation.\+try(fn)}}\label{README.md_autotoc_md17708}
This is an alias for {\ttfamily retry\+Operation.\+attempt(fn)}. This is deprecated. Please use {\ttfamily retry\+Operation.\+attempt(fn)} instead.\hypertarget{README.md_autotoc_md17709}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+start(fn)}{retry\+Operation.\+start(fn)}}\label{README.md_autotoc_md17709}
This is an alias for {\ttfamily retry\+Operation.\+attempt(fn)}. This is deprecated. Please use {\ttfamily retry\+Operation.\+attempt(fn)} instead.\hypertarget{README.md_autotoc_md17710}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+retry(error)}{retry\+Operation.\+retry(error)}}\label{README.md_autotoc_md17710}
Returns {\ttfamily false} when no {\ttfamily error} value is given, or the maximum amount of retries has been reached.

Otherwise it returns {\ttfamily true}, and retries the operation after the timeout for the current attempt number.\hypertarget{README.md_autotoc_md17711}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+stop()}{retry\+Operation.\+stop()}}\label{README.md_autotoc_md17711}
Allows you to stop the operation being retried. Useful for aborting the operation on a fatal error etc.\hypertarget{README.md_autotoc_md17712}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+reset()}{retry\+Operation.\+reset()}}\label{README.md_autotoc_md17712}
Resets the internal state of the operation object, so that you can call {\ttfamily attempt()} again as if this was a new operation object.\hypertarget{README.md_autotoc_md17713}{}\doxysubsubsubsubsection{\texorpdfstring{retry\+Operation.\+attempts()}{retry\+Operation.\+attempts()}}\label{README.md_autotoc_md17713}
Returns an int representing the number of attempts it took to call {\ttfamily fn} before it was successful.\hypertarget{README.md_autotoc_md17714}{}\doxysubsubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md17714}
retry is licensed under the MIT license.\hypertarget{README.md_autotoc_md17715}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{README.md_autotoc_md17715}
