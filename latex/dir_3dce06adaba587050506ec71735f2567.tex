\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/@ampproject/remapping Directory Reference}
\hypertarget{dir_3dce06adaba587050506ec71735f2567}{}\label{dir_3dce06adaba587050506ec71735f2567}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/"@ampproject/remapping Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/"@ampproject/remapping Directory Reference}}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md22}{}\doxysubsubsection{\texorpdfstring{Advanced control of the loading graph}{Advanced control of the loading graph}}\label{README.md_autotoc_md22}
\hypertarget{README.md_autotoc_md23}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily source}}{{\ttfamily source}}}\label{README.md_autotoc_md23}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md24}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily content}}{{\ttfamily content}}}\label{README.md_autotoc_md24}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md25}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md25}
\hypertarget{README.md_autotoc_md26}{}\doxysubsubsubsection{\texorpdfstring{exclude\+Content}{exclude\+Content}}\label{README.md_autotoc_md26}
By default, {\ttfamily exclude\+Content} is {\ttfamily false}. Passing {\ttfamily \{ exclude\+Content\+: true \}} will exclude the {\ttfamily sources\+Content} field from the returned sourcemap. This is mainly useful when you want to reduce the size out the sourcemap.\hypertarget{README.md_autotoc_md27}{}\doxysubsubsubsection{\texorpdfstring{decoded\+Mappings}{decoded\+Mappings}}\label{README.md_autotoc_md27}
