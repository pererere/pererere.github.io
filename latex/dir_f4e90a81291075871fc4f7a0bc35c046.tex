\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/json-\/parse-\/even-\/better-\/errors Directory Reference}
\hypertarget{dir_f4e90a81291075871fc4f7a0bc35c046}{}\label{dir_f4e90a81291075871fc4f7a0bc35c046}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/json-\/parse-\/even-\/better-\/errors Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/json-\/parse-\/even-\/better-\/errors Directory Reference}}
...
It also preserves the newline and indentation styles of the JSON data, by putting them in the object or array in the `Symbol.\+for(\textquotesingle{}indent'){\ttfamily and }Symbol.\+for(\textquotesingle{}newline\textquotesingle{})\`{} properties.\hypertarget{README.md_autotoc_md11039}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md11039}
{\ttfamily \$ npm install -\/-\/save json-\/parse-\/even-\/better-\/errors}\hypertarget{README.md_autotoc_md11040}{}\doxysubsection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{README.md_autotoc_md11040}
...
\item \`{}parse\`{}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md11041}{}\doxysubsubsection{\texorpdfstring{Example}{Example}}\label{README.md_autotoc_md11041}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11042}{}\doxysubsubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md11042}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md11043}{}\doxysubsection{\texorpdfstring{Indentation}{Indentation}}\label{README.md_autotoc_md11043}
...
Indentation is determined by looking at the whitespace between the initial {\ttfamily \{} and {\ttfamily \mbox{[}} and the character that follows it. If you have lots of weird inconsistent indentation, then it won\textquotesingle{}t track that or give you any way to preserve it. Whether this is a bug or a feature is debatable ;)\hypertarget{README.md_autotoc_md11044}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md11044}
\hypertarget{README.md_autotoc_md11045}{}\doxysubsubsubsection{\texorpdfstring{\label{_parse}%
 {\ttfamily parse(txt, reviver = null, context = 20)}}{\label{_parse}%
 {\ttfamily parse(txt, reviver = null, context = 20)}}}\label{README.md_autotoc_md11045}
Works just like {\ttfamily JSON.\+parse}, but will include a bit more information when an error happens, and attaches a `Symbol.\+for(\textquotesingle{}indent'){\ttfamily and }Symbol.\+for(\textquotesingle{}newline\textquotesingle{}){\ttfamily on objects and arrays. This throws a }JSONParse\+Error\`{}.\hypertarget{README.md_autotoc_md11046}{}\doxysubsubsubsection{\texorpdfstring{\label{_parse}%
 {\ttfamily parse.\+no\+Exceptions(txt, reviver = null)}}{\label{_parse}%
 {\ttfamily parse.\+no\+Exceptions(txt, reviver = null)}}}\label{README.md_autotoc_md11046}
Works just like {\ttfamily JSON.\+parse}, but will return {\ttfamily undefined} rather than throwing an error.\hypertarget{README.md_autotoc_md11047}{}\doxysubsubsubsection{\texorpdfstring{\label{_jsonparseerror}%
 {\ttfamily class JSONParse\+Error(er, text, context = 20, caller = null)}}{\label{_jsonparseerror}%
 {\ttfamily class JSONParse\+Error(er, text, context = 20, caller = null)}}}\label{README.md_autotoc_md11047}
