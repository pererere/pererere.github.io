\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/socks Directory Reference}
\hypertarget{dir_9f5d867fc6b4e251c293501a203c55ac}{}\label{dir_9f5d867fc6b4e251c293501a203c55ac}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/socks Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/socks Directory Reference}}
...
\hypertarget{README.md_autotoc_md19491}{}\doxysubsubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md19491}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md19492}{}\doxysubsubsection{\texorpdfstring{Requirements}{Requirements}}\label{README.md_autotoc_md19492}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md19493}{}\doxysubsubsection{\texorpdfstring{Looking for v1?}{Looking for v1?}}\label{README.md_autotoc_md19493}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md19494}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md19494}
{\ttfamily yarn add socks}

or

{\ttfamily npm install -\/-\/save socks}\hypertarget{README.md_autotoc_md19495}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md19495}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19496}{}\doxysubsection{\texorpdfstring{Quick Start Example}{Quick Start Example}}\label{README.md_autotoc_md19496}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19497}{}\doxysubsection{\texorpdfstring{Chaining Proxies}{Chaining Proxies}}\label{README.md_autotoc_md19497}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19498}{}\doxysubsection{\texorpdfstring{Bind Example (TCP Relay)}{Bind Example (TCP Relay)}}\label{README.md_autotoc_md19498}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19499}{}\doxysubsection{\texorpdfstring{Associate Example (UDP Relay)}{Associate Example (UDP Relay)}}\label{README.md_autotoc_md19499}
...
\DoxyCodeLine{\});}
\DoxyCodeLine{}
\DoxyCodeLine{let\ client\ =\ new\ SocksClient(options);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ data:\ Buffer.from('hello')}
\DoxyCodeLine{\ \ \});}
...
{\bfseries{Note\+:}} The associate TCP connection to the proxy must remain open for the UDP relay to work.\hypertarget{README.md_autotoc_md19500}{}\doxysubsection{\texorpdfstring{Additional Examples}{Additional Examples}}\label{README.md_autotoc_md19500}
\doxysectlink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2socks_2docs_2index}{Documentation}{0}\hypertarget{README.md_autotoc_md19501}{}\doxysubsection{\texorpdfstring{Migrating from v1}{Migrating from v1}}\label{README.md_autotoc_md19501}
Looking for a guide to migrate from v1? Look \doxysectlink{md__d_1_2_g_i_t_2_food_link_2foodlink_8client_2node__modules_2socks_2docs_2migrating_from_v1}{here}{0}\hypertarget{README.md_autotoc_md19502}{}\doxysubsection{\texorpdfstring{Api Reference\+:}{Api Reference\+:}}\label{README.md_autotoc_md19502}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{README.md_autotoc_md19503}{}\doxysubsubsection{\texorpdfstring{Socks\+Client}{Socks\+Client}}\label{README.md_autotoc_md19503}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md19504}{}\doxysubsubsection{\texorpdfstring{new Socks\+Client(options)}{new Socks\+Client(options)}}\label{README.md_autotoc_md19504}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md19505}{}\doxysubsubsection{\texorpdfstring{Socks\+Client\+Options}{Socks\+Client\+Options}}\label{README.md_autotoc_md19505}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19506}{}\doxysubsubsection{\texorpdfstring{Class Method\+: Socks\+Client.\+create\+Connection(options\mbox{[}, callback\mbox{]})}{Class Method\+: Socks\+Client.\+create\+Connection(options\mbox{[}, callback\mbox{]})}}\label{README.md_autotoc_md19506}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19507}{}\doxysubsubsection{\texorpdfstring{Class Method\+: Socks\+Client.\+create\+Connection\+Chain(options\mbox{[}, callback\mbox{]})}{Class Method\+: Socks\+Client.\+create\+Connection\+Chain(options\mbox{[}, callback\mbox{]})}}\label{README.md_autotoc_md19507}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19508}{}\doxysubsubsection{\texorpdfstring{Class Method\+: Socks\+Client.\+create\+UDPFrame(details)}{Class Method\+: Socks\+Client.\+create\+UDPFrame(details)}}\label{README.md_autotoc_md19508}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19509}{}\doxysubsubsection{\texorpdfstring{Class Method\+: Socks\+Client.\+parse\+UDPFrame(data)}{Class Method\+: Socks\+Client.\+parse\+UDPFrame(data)}}\label{README.md_autotoc_md19509}
...
Parses a Buffer instance and returns the parsed Socks\+UDPFrame\+Details object.\hypertarget{README.md_autotoc_md19510}{}\doxysubsection{\texorpdfstring{Event\+: \textquotesingle{}error\textquotesingle{}}{Event\+: \textquotesingle{}error\textquotesingle{}}}\label{README.md_autotoc_md19510}

\begin{DoxyItemize}
\item {\ttfamily err} \{ Socks\+Client\+Error \} -\/ An Error object containing an error message and the original Socks\+Client\+Options.
\end{DoxyItemize}

This event is emitted if an error occurs when trying to establish the proxy connection.\hypertarget{README.md_autotoc_md19511}{}\doxysubsection{\texorpdfstring{Event\+: \textquotesingle{}bound\textquotesingle{}}{Event\+: \textquotesingle{}bound\textquotesingle{}}}\label{README.md_autotoc_md19511}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19512}{}\doxysubsection{\texorpdfstring{Event\+: \textquotesingle{}established\textquotesingle{}}{Event\+: \textquotesingle{}established\textquotesingle{}}}\label{README.md_autotoc_md19512}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19513}{}\doxysubsection{\texorpdfstring{client.\+connect()}{client.\+connect()}}\label{README.md_autotoc_md19513}
Starts connecting to the remote SOCKS proxy server to establish a proxy connection to the destination host.\hypertarget{README.md_autotoc_md19514}{}\doxysubsection{\texorpdfstring{client.\+socks\+Client\+Options}{client.\+socks\+Client\+Options}}\label{README.md_autotoc_md19514}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md19515}{}\doxysubsection{\texorpdfstring{Further Reading\+:}{Further Reading\+:}}\label{README.md_autotoc_md19515}
Please read the SOCKS 5 specifications for more information on how to use BIND and Associate. \href{http://www.ietf.org/rfc/rfc1928.txt}{\texttt{ http\+://www.\+ietf.\+org/rfc/rfc1928.\+txt}}\hypertarget{README.md_autotoc_md19516}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md19516}
