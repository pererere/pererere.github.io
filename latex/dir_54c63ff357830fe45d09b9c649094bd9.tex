\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/serialize-\/javascript Directory Reference}
\hypertarget{dir_54c63ff357830fe45d09b9c649094bd9}{}\label{dir_54c63ff357830fe45d09b9c649094bd9}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/serialize-\/javascript Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/serialize-\/javascript Directory Reference}}


\doxysubsection{Detailed Description}
Serialize Java\+Script to a {\itshape superset} of JSON that includes regular expressions, dates and functions.

\href{https://www.npmjs.org/package/serialize-javascript}{\texttt{ }} \href{https://david-dm.org/yahoo/serialize-javascript}{\texttt{ }} \hypertarget{README.md_autotoc_md18773}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{README.md_autotoc_md18773}
...
Please note that serialization for ES6 Sets \& Maps requires support for {\ttfamily Array.\+from} (not available in IE or Node \texorpdfstring{$<$}{<} 0.\+12), or an {\ttfamily Array.\+from} polyfill.\hypertarget{README.md_autotoc_md18774}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md18774}
Install using npm\+:
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md18775}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md18775}
...
Note\+: to produce a beautified string, you can pass an optional second argument to {\ttfamily serialize()} to define the number of spaces to be used for the indentation.\hypertarget{README.md_autotoc_md18776}{}\doxysubsubsection{\texorpdfstring{Automatic Escaping of HTML Characters}{Automatic Escaping of HTML Characters}}\label{README.md_autotoc_md18776}
...
\hypertarget{README.md_autotoc_md18777}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md18777}
The {\ttfamily serialize()} function accepts an {\ttfamily options} object as its second argument. All options are being defaulted to {\ttfamily undefined}\+:\hypertarget{README.md_autotoc_md18778}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily options.\+space}}{{\ttfamily options.\+space}}}\label{README.md_autotoc_md18778}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md18779}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily options.\+is\+JSON}}{{\ttfamily options.\+is\+JSON}}}\label{README.md_autotoc_md18779}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md18780}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily options.\+unsafe}}{{\ttfamily options.\+unsafe}}}\label{README.md_autotoc_md18780}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md18781}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily options.\+ignore\+Function}}{{\ttfamily options.\+ignore\+Function}}}\label{README.md_autotoc_md18781}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md18782}{}\doxysubsection{\texorpdfstring{Deserializing}{Deserializing}}\label{README.md_autotoc_md18782}
...
{\bfseries{Note\+:}} Don\textquotesingle{}t forget the parentheses around the serialized javascript, as the opening bracket {\ttfamily \{} will be considered to be the start of a body.\hypertarget{README.md_autotoc_md18783}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md18783}
