\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/minizlib Directory Reference}
\hypertarget{dir_9f43c192dce26abefbb93c45b8938c39}{}\label{dir_9f43c192dce26abefbb93c45b8938c39}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/minizlib Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/minizlib Directory Reference}}
...
Brotli is supported in versions of node with a Brotli binding.\hypertarget{README.md_autotoc_md14521}{}\doxysubsection{\texorpdfstring{How does this differ from the streams in `require(\textquotesingle{}zlib')\`{}?}{How does this differ from the streams in `require(\textquotesingle{}zlib')\`{}?}}\label{README.md_autotoc_md14521}
...
See \href{http://npm.im/minipass}{\texttt{ Minipass}} for more on the differences between Node.\+js core streams and Minipass streams, and the convenience methods provided by that class.\hypertarget{README.md_autotoc_md14522}{}\doxysubsection{\texorpdfstring{Classes}{Classes}}\label{README.md_autotoc_md14522}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md14523}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md14523}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md14524}{}\doxysubsection{\texorpdfstring{REPRODUCIBLE BUILDS}{REPRODUCIBLE BUILDS}}\label{README.md_autotoc_md14524}
