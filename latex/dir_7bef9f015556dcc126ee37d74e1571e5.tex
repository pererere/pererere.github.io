\doxysection{D\+:/\+GIT/\+Food\+Link/foodlink.client/node\+\_\+modules/send/node\+\_\+modules/depd Directory Reference}
\hypertarget{dir_7bef9f015556dcc126ee37d74e1571e5}{}\label{dir_7bef9f015556dcc126ee37d74e1571e5}\index{D:/GIT/FoodLink/foodlink.client/node\_modules/send/node\_modules/depd Directory Reference@{D:/GIT/FoodLink/foodlink.client/node\_modules/send/node\_modules/depd Directory Reference}}
...
\hypertarget{Readme.md_autotoc_md18652}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{Readme.md_autotoc_md18652}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{Readme.md_autotoc_md18653}{}\doxysubsection{\texorpdfstring{API}{API}}\label{Readme.md_autotoc_md18653}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{Readme.md_autotoc_md18656}{}\doxysubsubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.\+function(fn, message)}}\label{Readme.md_autotoc_md18656}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{Readme.md_autotoc_md18657}{}\doxysubsubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.\+property(obj, prop, message)}}\label{Readme.md_autotoc_md18657}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18659}{}\doxysubsubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.\+env.\+NO\+\_\+\+DEPRECATION}}\label{Readme.md_autotoc_md18659}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{Readme.md_autotoc_md18660}{}\doxysubsubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.\+env.\+TRACE\+\_\+\+DEPRECATION}}\label{Readme.md_autotoc_md18660}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{Readme.md_autotoc_md18661}{}\doxysubsection{\texorpdfstring{Display}{Display}}\label{Readme.md_autotoc_md18661}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18662}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{Readme.md_autotoc_md18662}
\hypertarget{Readme.md_autotoc_md18663}{}\doxysubsubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{Readme.md_autotoc_md18663}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18664}{}\doxysubsubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{Readme.md_autotoc_md18664}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18665}{}\doxysubsubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{Readme.md_autotoc_md18665}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md18666}{}\doxysubsection{\texorpdfstring{License}{License}}\label{Readme.md_autotoc_md18666}
